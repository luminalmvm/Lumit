...
class BridgeLib
  ...
  @override
  int get rustContentHash => 1544558071;
...
abstract class BridgeLibApi extends BaseApi {
  ...
  bool crateApiAudioAudioMuted();

  void crateApiAudioAudioPause();

  void crateApiAudioAudioSeek({required double secs});

  void crateApiAudioAudioSetMuted({required bool muted});
...
class BridgeLibApiImpl extends BridgeLibApiImplPlatform
  ...
  bool crateApiAudioAudioMuted() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiAudioAudioMutedConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiAudioAudioMutedConstMeta => const TaskConstMeta(
        debugName: "audio_muted",
        argNames: [],
      );
  ...
  void crateApiAudioAudioSetMuted({required bool muted}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiAudioAudioSetMutedConstMeta,
      argValues: [muted],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiAudioAudioSetMutedConstMeta => const TaskConstMeta(
        debugName: "audio_set_muted",
        argNames: ["muted"],
      );
