...
class BridgeLib
  ...
  @override
  int get rustContentHash => 1408942841;
  ...
  int crateApiCompositionCompositionReferenceQueueExport(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_bool(openFolder, serializer);
      ...
      argValues: [that, spec, path, start, openFolder],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceQueueExportConstMeta =>
          const TaskConstMeta(
            ...
            argNames: ["that", "spec", "path", "start", "openFolder"],
          );
