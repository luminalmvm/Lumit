...
class BridgeLib
  ...
  @override
  int get rustContentHash => -949364872;
...
abstract class BridgeLibApi extends BaseApi {
  ...
  void crateApiCompositionCompositionReferencePreviewNode(
      {required CompositionReference that,
...
class BridgeLibApiImpl extends BridgeLibApiImplPlatform
  ...
  void crateApiCompositionCompositionReferencePreviewNode(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferencePreviewNodeConstMeta,
      argValues: [that, frame, layer, node, maxEdge],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferencePreviewNodeConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_preview_node",
            argNames: ["that", "frame", "layer", "node", "maxEdge"],
          );
  ...
  BridgeNodePreview dco_decode_box_autoadd_bridge_node_preview(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_node_preview(raw);
  }
  ...
  WorkerResponse dco_decode_worker_response(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 4:
        return WorkerResponse_NodePreview(
          dco_decode_box_autoadd_bridge_node_preview(raw[1]),
        );
      case 5:
  ...
  BridgeNodePreview sse_decode_box_autoadd_bridge_node_preview(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_node_preview(deserializer));
  }
  ...
  WorkerResponse sse_decode_worker_response(SseDeserializer deserializer) {
    ...
    switch (tag_) {
      ...
      case 4:
        var var_field0 =
            sse_decode_box_autoadd_bridge_node_preview(deserializer);
        return WorkerResponse_NodePreview(var_field0);
      case 5:
        return WorkerResponse_PlaybackEnded();
      case 6:
        return WorkerResponse_CacheFilled();
  ...
  void sse_encode_box_autoadd_bridge_node_preview(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_node_preview(self, serializer);
  }
  ...
  void sse_encode_worker_response(
    ...
    switch (self) {
      ...
      case WorkerResponse_NodePreview(field0: final field0):
        sse_encode_i_32(4, serializer);
        sse_encode_box_autoadd_bridge_node_preview(field0, serializer);
