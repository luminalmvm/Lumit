...
class BridgeLib
  ...
  @override
  int get rustContentHash => 708047571;
...
abstract class BridgeLibApi extends BaseApi {
  ...
  List<BridgeParamInfo> crateApiEffectBridgeEffectInstanceListParameters(
      {required BridgeEffectInstance that});
  ...
  void crateApiEffectBridgeEffectInstanceRotoAddStroke(
      {required BridgeEffectInstance that,
  ...
  void crateApiEffectBridgeEffectInstanceRotoClear(
      {required BridgeEffectInstance that});

  void crateApiEffectBridgeEffectInstanceRotoSetBaseFrame(
      {required BridgeEffectInstance that, PlatformInt64? frame});

  List<BridgeRotoStroke> crateApiEffectBridgeEffectInstanceRotoStrokes(
      {required BridgeEffectInstance that});
  ...
  void crateApiEffectBridgeEffectInstanceSetShaderGraph(
      {required BridgeEffectInstance that, required String graph});

  void crateApiEffectBridgeEffectInstanceSetShaderSource(
      {required BridgeEffectInstance that,
  ...
  String? crateApiEffectBridgeEffectInstanceShaderGraph(
      {required BridgeEffectInstance that});

  String? crateApiEffectBridgeEffectInstanceShaderOrigin(
      {required BridgeEffectInstance that});

  String? crateApiEffectBridgeEffectInstanceShaderSource(
      {required BridgeEffectInstance that});

  BridgeShaderStatus crateApiEffectBridgeEffectInstanceShaderStatus(
      {required BridgeEffectInstance that});
  ...
  List<BridgeAudioMeter> crateApiAudioAudioMeters();
  ...
  BridgeBeatOptions crateApiBeatsBridgeBeatOptionsStandard();
  ...
  double crateApiLayerCameraApertureForFStop(
      {required double fStop, required double zoom});

  double crateApiLayerCameraFStop(
      {required double zoom, required double aperture});

  BridgeCameraLens crateApiLayerCameraLens(
      {required double zoom, required double filmMm, required double compW});

  BridgeCameraLink crateApiTrackCameraLink(
      {required LayerReference camera, required PlatformInt64 frame});

  Float64List crateApiLayerCameraPresetsMm();

  BridgeCameraPose crateApiLayerCameraViewPose(
      {required BridgeCameraView view,
      required double width,
      required double height});

  double crateApiLayerCameraZoomForAngle(
      {required double angleDeg, required double compW});

  double crateApiLayerCameraZoomForFocal(
      {required double focalMm, required double filmMm, required double compW});
  ...
  LayerReference crateApiCompositionCompositionReferenceAddAdjustmentLayer(
      {required CompositionReference that, int? row});
  ...
  void crateApiCompositionCompositionReferenceAddGroupEffect(
      {required CompositionReference that,
      required UuidValue group,
      required String name});

  LayerReference crateApiCompositionCompositionReferenceAddLightLayer(
      {required CompositionReference that, required int kind, int? row});
  ...
  Future<BridgeAudioPeaks> crateApiCompositionCompositionReferenceAudioMixPeaks(
      {required CompositionReference that,
  ...
  Future<BridgeBeatsResult> crateApiCompositionCompositionReferenceDetectBeats(
      {required CompositionReference that, required BridgeBeatOptions options});
  ...
  UuidValue crateApiCompositionCompositionReferenceGroupLayers(
      {required CompositionReference that,
      required List<UuidValue> layerIds,
      required String name});

  double crateApiCompositionCompositionReferenceMasterVolumeDb(
      {required CompositionReference that});
  ...
  LayerReference crateApiCompositionCompositionReferencePrecomposeSoundMix(
      {required CompositionReference that, required String name});
  ...
  void crateApiCompositionCompositionReferenceSetBeatGrid(
      {required CompositionReference that, BridgeBeatGrid? grid});

  void crateApiCompositionCompositionReferenceSetCameraView(
      {required CompositionReference that, BridgeCameraPose? view});

  void crateApiCompositionCompositionReferenceSetGroupLabel(
      {required CompositionReference that,
      required UuidValue group,
      required int label});

  void crateApiCompositionCompositionReferenceSetGroupName(
      {required CompositionReference that,
      required UuidValue group,
      required String name});

  void crateApiCompositionCompositionReferenceSetGroupSwitch(
      {required CompositionReference that,
      required UuidValue group,
  ...
  void crateApiCompositionCompositionReferenceSetMasterVolumeDb(
      {required CompositionReference that, required double db});
  ...
  void crateApiCompositionCompositionReferenceSetSoundMix(
      {required CompositionReference that, required bool mixed});

  void crateApiCompositionCompositionReferenceSetSwitchOnLayers(
      {required CompositionReference that,
  ...
  void crateApiCompositionCompositionReferenceSlideLayers(
      {required CompositionReference that,
      required List<UuidValue> layerIds,
      required PlatformInt64 delta});

  bool crateApiCompositionCompositionReferenceSoundMix(
      {required CompositionReference that});
  ...
  Future<BridgeRenderedFrame?> crateApiCompositionCompositionReferenceThumbnail(
      {required CompositionReference that,
      required BigInt frame,
  ...
  List<BridgeRational> crateApiCompositionCompositionReferenceTimesOfFrames(
      {required CompositionReference that,
      required PlatformInt64 first,
      required int count});

  void crateApiCompositionCompositionReferenceTrimToWorkArea(
      {required CompositionReference that});

  void crateApiCompositionCompositionReferenceUngroup(
      {required CompositionReference that, required UuidValue group});

  bool crateApiCompositionCompositionReferenceUngroupSelection(
      {required CompositionReference that, required List<UuidValue> layerIds});

  BridgeWireframes crateApiCompositionCompositionReferenceWireframes(
      {required CompositionReference that,
      required BigInt frame,
  ...
  void crateApiExportExportDefaultsSet(
      {required BridgeExportDefaults defaults});
  ...
  bool crateApiFootageFootageReferencePreviewAudio(
      {required FootageReference that});
  ...
  void crateApiFootageFootageReferenceRenderView(
      {required FootageReference that,
      required BigInt frame,
      required double scale,
      required int width,
  ...
  BridgeGovernorReport crateApiCacheGovernorReport();
  ...
  void crateApiLayerLayerReferenceAddClip(
      {required LayerReference that,
      required FootageReference footage,
      required PlatformInt64 atFrame,
      required bool overlap});

  void crateApiLayerLayerReferenceAddClipEffect(
      {required LayerReference that,
      required UuidValue clip,
      required String name});
  ...
  void crateApiLayerLayerReferenceAddPuppetPin(
      {required LayerReference that, required BridgePuppetPin pin});

  UuidValue crateApiLayerLayerReferenceAddPuppetPinAt(
      {required LayerReference that,
      required PlatformInt64 frame,
  ...
  void crateApiLayerLayerReferenceAddStyle(
      {required LayerReference that, required String name});

  void crateApiLayerLayerReferenceArmPuppetPreview(
      {required LayerReference that,
  ...
  Future<BridgeSpectrogram> crateApiLayerLayerReferenceAudioSpectrogram(
      {required LayerReference that,
      required double startSeconds,
      required double endSeconds,
      required int columns});

  BridgeCameraPose? crateApiLayerLayerReferenceCameraPoseAt(
      {required LayerReference that, required BigInt frame});
  ...
  void crateApiLayerLayerReferenceClearShapePathKeys(
      {required LayerReference that,
      required UuidValue id,
      required BridgeRational time});
  ...
  Future<BridgeSpectrogram> crateApiLayerLayerReferenceClipAudioSpectrogram(
      {required LayerReference that,
      required UuidValue clip,
      required double startSeconds,
      required double endSeconds,
  ...
  LayerReference crateApiLayerLayerReferenceCreatePointsFromText(
      {required LayerReference that});

  LayerReference crateApiLayerLayerReferenceCreateShapesFromText(
  ...
  void crateApiLayerLayerReferenceDeletePuppetPin(
      {required LayerReference that, required UuidValue id});

  void crateApiLayerLayerReferenceDeleteStroke(
      {required LayerReference that, required UuidValue id});

  Future<LayerReference> crateApiLayerLayerReferenceDetachAudio(
      {required LayerReference that});
  ...
  void crateApiLayerLayerReferenceFadeIn(
      {required LayerReference that,
      required double seconds,
      required BridgeFadeShape shape});

  void crateApiLayerLayerReferenceFadeOut(
      {required LayerReference that,
      required double seconds,
      required BridgeFadeShape shape});

  void crateApiLayerLayerReferenceFreezeAtPlayhead(
      {required LayerReference that, required PlatformInt64 frame});

  int crateApiLayerLayerReferenceGetBlend({required LayerReference that});

  BridgeCameraSettings? crateApiLayerLayerReferenceGetCameraSettings(
      {required LayerReference that});

  BridgeScalar? crateApiLayerLayerReferenceGetCameraZoom(
      {required LayerReference that});

  List<BridgeEffectInstance> crateApiLayerLayerReferenceGetClipEffects(
      {required LayerReference that, required UuidValue clip});
  ...
  BridgeScalar crateApiLayerLayerReferenceGetPan(
      {required LayerReference that});

  UuidValue? crateApiLayerLayerReferenceGetParent(
      {required LayerReference that});

  BridgePuppet? crateApiLayerLayerReferenceGetPuppet(
      {required LayerReference that});
  ...
  List<BridgeEffectInstance> crateApiLayerLayerReferenceGetStyles(
      {required LayerReference that});
  ...
  void crateApiLayerLayerReferenceInsertNodeGroup(
      {required LayerReference that,
      required String text,
      required double x,
      required double y});
  ...
  bool crateApiLayerLayerReferenceMoveShapePathKey(
      {required LayerReference that,
      required UuidValue id,
      required BridgeRational from,
      required BridgeRational to});

  PlatformInt64? crateApiLayerLayerReferenceNestedEntryFrame(
      {required LayerReference that, required PlatformInt64 outerFrame});
  ...
  BridgePuppetGhost? crateApiLayerLayerReferencePuppetGhost(
      {required LayerReference that});
  ...
  void crateApiLayerLayerReferenceRenderView(
      {required LayerReference that,
      required BigInt frame,
      required double scale,
      required int width,
  ...
  UuidValue crateApiLayerLayerReferenceRotoFirstStroke(
      {required LayerReference that,
      required List<double> points,
      required double radius,
      required BridgeRotoStrokeKind kind,
  ...
  String crateApiLayerLayerReferenceSaveNodeGroup(
      {required LayerReference that,
      required String name,
      required int colour,
  ...
  void crateApiLayerLayerReferenceSetCameraSettings(
      {required LayerReference that, required BridgeCameraSettings settings});

  void crateApiLayerLayerReferenceSetCameraZoom(
      {required LayerReference that, required BridgeScalar zoom});

  void crateApiLayerLayerReferenceSetClipFade(
      {required LayerReference that,
      required UuidValue clip,
      BridgeClipFade? fadeIn,
      BridgeClipFade? fadeOut});

  void crateApiLayerLayerReferenceSetClipFx(
      {required LayerReference that,
      required UuidValue clip,
      required bool on_});

  void crateApiLayerLayerReferenceSetClipGain(
      {required LayerReference that,
      required UuidValue clip,
      required double db});
  ...
  void crateApiLayerLayerReferenceSetPan(
      {required LayerReference that, required BridgeScalar value});
  ...
  void crateApiLayerLayerReferenceSetPuppetPin(
      {required LayerReference that, required BridgePuppetPin pin});
  ...
  bool crateApiLayerLayerReferenceSetShapePathKeys(
      {required LayerReference that,
      required UuidValue id,
      required List<BridgeKeyframe> keys});
  ...
  void crateApiLayerLayerReferenceStretch(
      {required LayerReference that, required double speedPercent});
  ...
  void crateApiLayerLayerReferenceToggleShapePathKey(
      {required LayerReference that,
      required UuidValue id,
      required BridgeRational time});
  ...
  BridgePlanarStatus crateApiTrackPlanarStatus(
  ...
  int crateApiProjectProjectReferenceAppliedSteps(
      {required ProjectReference that});
  ...
  void crateApiProjectProjectReferenceCloseViewerView(
      {required ProjectReference that, required int view});

  int crateApiProjectProjectReferenceColourDepth(
      {required ProjectReference that});

  int crateApiProjectProjectReferenceColourDepthInUse(
      {required ProjectReference that});
  ...
  List<BridgeHistoryEntry> crateApiProjectProjectReferenceHistoryEntries(
      {required ProjectReference that});
  ...
  void crateApiProjectProjectReferenceJumpHistory(
      {required ProjectReference that, required int applied});
  ...
  void crateApiProjectProjectReferenceSetColourDepth(
      {required ProjectReference that, required int bits});

  void crateApiProjectProjectReferenceSetColourWorkingSpace(
      {required ProjectReference that, required bool fromConfig});
  ...
  Float32List crateApiRotoRotoBoundary(
      {required UuidValue effect, required PlatformInt64 frame});

  bool crateApiRotoRotoSolveFrame(
      {required LayerReference layer,
      required UuidValue effect,
      required PlatformInt64 frame});

  PlatformInt64 crateApiRotoRotoSourceFrame(
      {required LayerReference layer, required PlatformInt64 frame});

  BridgeRotoStatus crateApiRotoRotoStatus(
      {required LayerReference layer, required UuidValue effect});
  ...
  Float64List crateApiEffectSampleScalars(
...
class BridgeLibApiImpl extends BridgeLibApiImplPlatform
  ...
  void crateApiEffectBridgeEffectInstanceDetachShaderGraph(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceDetachShaderGraphConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiEffectBridgeEffectInstanceDetachShaderGraphConstMeta =>
          const TaskConstMeta(
            debugName: "BridgeEffectInstance_detach_shader_graph",
            argNames: ["that"],
          );
  ...
  List<BridgeParamInfo> crateApiEffectBridgeEffectInstanceListParameters(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceListParametersConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiEffectBridgeEffectInstanceListParametersConstMeta =>
          const TaskConstMeta(
            debugName: "BridgeEffectInstance_list_parameters",
            argNames: ["that"],
          );
  ...
  void crateApiEffectBridgeEffectInstanceRotoAddStroke(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceRotoAddStrokeConstMeta,
      argValues: [that, points, radius, kind, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectBridgeEffectInstanceRotoAddStrokeConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEffectInstance_roto_add_stroke",
        argNames: ["that", "points", "radius", "kind", "frame"],
      );
  ...
  void crateApiEffectBridgeEffectInstanceRotoClear(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceRotoClearConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectBridgeEffectInstanceRotoClearConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEffectInstance_roto_clear",
        argNames: ["that"],
      );
  ...
  void crateApiEffectBridgeEffectInstanceRotoSetBaseFrame(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceRotoSetBaseFrameConstMeta,
  ...
  TaskConstMeta
      get kCrateApiEffectBridgeEffectInstanceRotoSetBaseFrameConstMeta =>
          const TaskConstMeta(
            debugName: "BridgeEffectInstance_roto_set_base_frame",
            argNames: ["that", "frame"],
          );
  ...
  List<BridgeRotoStroke> crateApiEffectBridgeEffectInstanceRotoStrokes(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceRotoStrokesConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectBridgeEffectInstanceRotoStrokesConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEffectInstance_roto_strokes",
        argNames: ["that"],
      );
  ...
  void crateApiEffectBridgeEffectInstanceSetShaderGraph(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceSetShaderGraphConstMeta,
      argValues: [that, graph],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiEffectBridgeEffectInstanceSetShaderGraphConstMeta =>
          const TaskConstMeta(
            debugName: "BridgeEffectInstance_set_shader_graph",
            argNames: ["that", "graph"],
          );
  ...
  void crateApiEffectBridgeEffectInstanceSetShaderSource(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceSetShaderSourceConstMeta,
      argValues: [that, source, origin],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiEffectBridgeEffectInstanceSetShaderSourceConstMeta =>
          const TaskConstMeta(
            debugName: "BridgeEffectInstance_set_shader_source",
            argNames: ["that", "source", "origin"],
          );
  ...
  String? crateApiEffectBridgeEffectInstanceShaderGraph(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceShaderGraphConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectBridgeEffectInstanceShaderGraphConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEffectInstance_shader_graph",
        argNames: ["that"],
      );
  ...
  String? crateApiEffectBridgeEffectInstanceShaderOrigin(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceShaderOriginConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectBridgeEffectInstanceShaderOriginConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEffectInstance_shader_origin",
        argNames: ["that"],
      );
  ...
  String? crateApiEffectBridgeEffectInstanceShaderSource(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceShaderSourceConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectBridgeEffectInstanceShaderSourceConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEffectInstance_shader_source",
        argNames: ["that"],
      );
  ...
  BridgeShaderStatus crateApiEffectBridgeEffectInstanceShaderStatus(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectBridgeEffectInstanceShaderStatusConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectBridgeEffectInstanceShaderStatusConstMeta =>
      const TaskConstMeta(
        debugName: "BridgeEffectInstance_shader_status",
        argNames: ["that"],
      );
  ...
  List<BridgeAudioMeter> crateApiAudioAudioMeters() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiAudioAudioMetersConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiAudioAudioMetersConstMeta => const TaskConstMeta(
        debugName: "audio_meters",
        argNames: [],
      );
  ...
  BridgeBeatOptions crateApiBeatsBridgeBeatOptionsStandard() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiBeatsBridgeBeatOptionsStandardConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiBeatsBridgeBeatOptionsStandardConstMeta =>
      const TaskConstMeta(
        debugName: "bridge_beat_options_standard",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiExportBridgeExportDefaultsDefaultConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiEffectBridgePluginScanDefaultConstMeta =>
      const TaskConstMeta(
  ...
  double crateApiLayerCameraApertureForFStop(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerCameraApertureForFStopConstMeta,
      argValues: [fStop, zoom],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerCameraApertureForFStopConstMeta =>
      const TaskConstMeta(
        debugName: "camera_aperture_for_f_stop",
        argNames: ["fStop", "zoom"],
      );
  ...
  double crateApiLayerCameraFStop(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerCameraFStopConstMeta,
      argValues: [zoom, aperture],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerCameraFStopConstMeta => const TaskConstMeta(
        debugName: "camera_f_stop",
        argNames: ["zoom", "aperture"],
      );
  ...
  BridgeCameraLens crateApiLayerCameraLens(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerCameraLensConstMeta,
      argValues: [zoom, filmMm, compW],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerCameraLensConstMeta => const TaskConstMeta(
        debugName: "camera_lens",
        argNames: ["zoom", "filmMm", "compW"],
      );
  ...
  Float64List crateApiLayerCameraPresetsMm() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerCameraPresetsMmConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerCameraPresetsMmConstMeta =>
      const TaskConstMeta(
        debugName: "camera_presets_mm",
        argNames: [],
      );
  ...
  BridgeCameraPose crateApiLayerCameraViewPose(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerCameraViewPoseConstMeta,
      argValues: [view, width, height],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerCameraViewPoseConstMeta =>
      const TaskConstMeta(
        debugName: "camera_view_pose",
        argNames: ["view", "width", "height"],
      );
  ...
  double crateApiLayerCameraZoomForAngle(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerCameraZoomForAngleConstMeta,
      argValues: [angleDeg, compW],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerCameraZoomForAngleConstMeta =>
      const TaskConstMeta(
        debugName: "camera_zoom_for_angle",
        argNames: ["angleDeg", "compW"],
      );
  ...
  double crateApiLayerCameraZoomForFocal(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerCameraZoomForFocalConstMeta,
      argValues: [focalMm, filmMm, compW],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerCameraZoomForFocalConstMeta =>
      const TaskConstMeta(
        debugName: "camera_zoom_for_focal",
        argNames: ["focalMm", "filmMm", "compW"],
      );
  ...
  TaskConstMeta get kCrateApiTrackClearCameraCorrectionsConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiCompositionCompositionReferenceAddFootageLayer(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, footage, asSequence, row],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceAddFootageLayerConstMeta =>
          const TaskConstMeta(
            ...
            argNames: ["that", "footage", "asSequence", "row"],
          );
  ...
  void crateApiCompositionCompositionReferenceAddGroupEffect(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceAddGroupEffectConstMeta,
      argValues: [that, group, name],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceAddGroupEffectConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_add_group_effect",
            argNames: ["that", "group", "name"],
          );
  ...
  Future<BridgeAudioPeaks> crateApiCompositionCompositionReferenceAudioMixPeaks(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceAudioMixPeaksConstMeta,
      argValues: [that, startSeconds, endSeconds, buckets],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceAudioMixPeaksConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_audio_mix_peaks",
            argNames: ["that", "startSeconds", "endSeconds", "buckets"],
          );
  ...
  void crateApiCompositionCompositionReferenceCropToRegion(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceCropToRegionConstMeta,
      argValues: [that, region],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceCropToRegionConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_crop_to_region",
            argNames: ["that", "region"],
          );
  ...
  BridgeBeatGrid? crateApiCompositionCompositionReferenceGetBeatGrid(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceGetBeatGridConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceGetBeatGridConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_get_beat_grid",
            argNames: ["that"],
          );
  ...
  List<BridgeEffectInstance>
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceGetGroupEffectsConstMeta,
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceGetGroupEffectsConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_get_group_effects",
            argNames: ["that", "group"],
          );
  ...
  UuidValue crateApiCompositionCompositionReferenceGroupLayers(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceGroupLayersConstMeta,
      argValues: [that, layerIds, name],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceGroupLayersConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_group_layers",
            argNames: ["that", "layerIds", "name"],
          );
  ...
  double crateApiCompositionCompositionReferenceMasterVolumeDb(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceMasterVolumeDbConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceMasterVolumeDbConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_master_volume_db",
            argNames: ["that"],
          );
  ...
  void crateApiCompositionCompositionReferencePlay(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, from, scale, mode, view],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiCompositionCompositionReferencePlayConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["that", "from", "scale", "mode", "view"],
      );
  ...
  LayerReference crateApiCompositionCompositionReferencePrecompose(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, layerIds, name, leaveAttributes, adjustDuration, group],
      apiImpl: this,
    ));
  }
  ...
  LayerReference crateApiCompositionCompositionReferencePrecomposeSoundMix(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferencePrecomposeSoundMixConstMeta,
      argValues: [that, name],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferencePrecomposeSoundMixConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_precompose_sound_mix",
            argNames: ["that", "name"],
          );
  ...
  void crateApiCompositionCompositionReferenceRenderFrame(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, frame, scale, mode, prefix, view],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceRenderFrameConstMeta =>
          const TaskConstMeta(
            ...
            argNames: ["that", "frame", "scale", "mode", "prefix", "view"],
          );
  ...
  void crateApiCompositionCompositionReferenceSamplePixels(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, frame, u, v, window, scale, layer, view],
      apiImpl: this,
    ));
  }
  ...
  void crateApiCompositionCompositionReferenceSetBeatGrid(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceSetBeatGridConstMeta,
      argValues: [that, grid],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetBeatGridConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_beat_grid",
            argNames: ["that", "grid"],
          );
  ...
  void crateApiCompositionCompositionReferenceSetCameraView(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceSetCameraViewConstMeta,
      argValues: [that, view],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetCameraViewConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_camera_view",
            argNames: ["that", "view"],
          );
  ...
  void crateApiCompositionCompositionReferenceSetGroupLabel(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceSetGroupLabelConstMeta,
      argValues: [that, group, label],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetGroupLabelConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_group_label",
            argNames: ["that", "group", "label"],
          );
  ...
  void crateApiCompositionCompositionReferenceSetGroupName(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceSetGroupNameConstMeta,
      argValues: [that, group, name],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetGroupNameConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_group_name",
            argNames: ["that", "group", "name"],
          );
  ...
  void crateApiCompositionCompositionReferenceSetGroupSwitch(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceSetGroupSwitchConstMeta,
      argValues: [that, group, switch_, on_],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetGroupSwitchConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_group_switch",
            argNames: ["that", "group", "switch_", "on_"],
          );
  ...
  void crateApiCompositionCompositionReferenceSetMasterVolumeDb(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceSetMasterVolumeDbConstMeta,
      argValues: [that, db],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetMasterVolumeDbConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_master_volume_db",
            argNames: ["that", "db"],
          );
  ...
  void crateApiCompositionCompositionReferenceSetSoundMix(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceSetSoundMixConstMeta,
      argValues: [that, mixed],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetSoundMixConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_sound_mix",
            argNames: ["that", "mixed"],
          );
  ...
  void crateApiCompositionCompositionReferenceSetSwitchOnLayers(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_box_autoadd_composition_reference(that, serializer);
        sse_encode_Uuid(clicked, serializer);
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceSetSwitchOnLayersConstMeta,
      argValues: [that, clicked, layers, switch_, on_],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSetSwitchOnLayersConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_set_switch_on_layers",
            argNames: ["that", "clicked", "layers", "switch_", "on_"],
          );
  ...
  void crateApiCompositionCompositionReferenceShiftGroup(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceShiftGroupConstMeta,
      argValues: [that, group, delta],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceShiftGroupConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_shift_group",
            argNames: ["that", "group", "delta"],
          );
  ...
  void crateApiCompositionCompositionReferenceSlideLayers(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceSlideLayersConstMeta,
      argValues: [that, layerIds, delta],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceSlideLayersConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_slide_layers",
            argNames: ["that", "layerIds", "delta"],
          );
  ...
  bool crateApiCompositionCompositionReferenceSoundMix(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceSoundMixConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCompositionCompositionReferenceSoundMixConstMeta =>
      const TaskConstMeta(
        debugName: "composition_reference_sound_mix",
        argNames: ["that"],
      );
  ...
  Future<BridgeRenderedFrame?> crateApiCompositionCompositionReferenceThumbnail(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceThumbnailConstMeta,
      argValues: [that, frame, maxEdge],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceThumbnailConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_thumbnail",
            argNames: ["that", "frame", "maxEdge"],
          );
  ...
  List<BridgeRational> crateApiCompositionCompositionReferenceTimesOfFrames(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceTimesOfFramesConstMeta,
      argValues: [that, first, count],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceTimesOfFramesConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_times_of_frames",
            argNames: ["that", "first", "count"],
          );
  ...
  void crateApiCompositionCompositionReferenceTrimToWorkArea(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceTrimToWorkAreaConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceTrimToWorkAreaConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_trim_to_work_area",
            argNames: ["that"],
          );
  ...
  void crateApiCompositionCompositionReferenceUngroup(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceUngroupConstMeta,
      argValues: [that, group],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCompositionCompositionReferenceUngroupConstMeta =>
      const TaskConstMeta(
        debugName: "composition_reference_ungroup",
        argNames: ["that", "group"],
      );
  ...
  bool crateApiCompositionCompositionReferenceUngroupSelection(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta:
          kCrateApiCompositionCompositionReferenceUngroupSelectionConstMeta,
      argValues: [that, layerIds],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceUngroupSelectionConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_ungroup_selection",
            argNames: ["that", "layerIds"],
          );
  ...
  BridgeWireframes crateApiCompositionCompositionReferenceWireframes(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCompositionCompositionReferenceWireframesConstMeta,
      argValues: [that, frame, view, mediaSizes],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiCompositionCompositionReferenceWireframesConstMeta =>
          const TaskConstMeta(
            debugName: "composition_reference_wireframes",
            argNames: ["that", "frame", "view", "mediaSizes"],
          );
  ...
  TaskConstMeta get kCrateApiTrackCreateCornerPinConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiLayerDisarmPuppetPreview() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerDisarmPuppetPreviewConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerDisarmPuppetPreviewConstMeta =>
      const TaskConstMeta(
        debugName: "disarm_puppet_preview",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiExportExportDefaultsGetConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiExportExportDefaultsSetConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiTrackFireEffectAction(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [layer, effect, param, frame],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiTrackFireEffectActionConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["layer", "effect", "param", "frame"],
      );
  ...
  bool crateApiFootageFootageReferencePreviewAudio(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiFootageFootageReferencePreviewAudioConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiFootageFootageReferencePreviewAudioConstMeta =>
      const TaskConstMeta(
        debugName: "footage_reference_preview_audio",
        argNames: ["that"],
      );
  ...
  void crateApiFootageFootageReferenceRenderView(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_u_32(width, serializer);
        sse_encode_u_32(height, serializer);
        sse_encode_u_32(rateNum, serializer);
      ...
      constMeta: kCrateApiFootageFootageReferenceRenderViewConstMeta,
      argValues: [
        that,
        frame,
        scale,
  ...
  TaskConstMeta get kCrateApiFootageFootageReferenceRenderViewConstMeta =>
      const TaskConstMeta(
        debugName: "footage_reference_render_view",
        argNames: [
          "that",
          "frame",
          "scale",
  ...
  BridgeGovernorReport crateApiCacheGovernorReport() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiCacheGovernorReportConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCacheGovernorReportConstMeta =>
      const TaskConstMeta(
        debugName: "governor_report",
        argNames: [],
      );
  ...
  void crateApiLayerLayerReferenceAddClip(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceAddClipConstMeta,
      argValues: [that, footage, atFrame, overlap],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceAddClipConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_add_clip",
        argNames: ["that", "footage", "atFrame", "overlap"],
      );
  ...
  void crateApiLayerLayerReferenceAddClipEffect(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceAddClipEffectConstMeta,
      argValues: [that, clip, name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceAddClipEffectConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_add_clip_effect",
        argNames: ["that", "clip", "name"],
      );
  ...
  void crateApiLayerLayerReferenceAddPuppetPin(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceAddPuppetPinConstMeta,
      argValues: [that, pin],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceAddPuppetPinConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_add_puppet_pin",
        argNames: ["that", "pin"],
      );
  ...
  UuidValue crateApiLayerLayerReferenceAddPuppetPinAt(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_box_autoadd_layer_reference(that, serializer);
        sse_encode_i_64(frame, serializer);
        sse_encode_bridge_puppet_pin_kind(kind, serializer);
        sse_encode_String(name, serializer);
        sse_encode_f_64(x, serializer);
        sse_encode_f_64(y, serializer);
      ...
      constMeta: kCrateApiLayerLayerReferenceAddPuppetPinAtConstMeta,
      argValues: [that, frame, kind, name, x, y],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceAddPuppetPinAtConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_add_puppet_pin_at",
        argNames: ["that", "frame", "kind", "name", "x", "y"],
      );
  ...
  void crateApiLayerLayerReferenceAddStyle(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceAddStyleConstMeta,
      argValues: [that, name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceAddStyleConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_add_style",
        argNames: ["that", "name"],
      );
  ...
  void crateApiLayerLayerReferenceArmPuppetPreview(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceArmPuppetPreviewConstMeta,
      argValues: [that, density, expansion],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceArmPuppetPreviewConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_arm_puppet_preview",
        argNames: ["that", "density", "expansion"],
      );
  ...
  Future<BridgeSpectrogram> crateApiLayerLayerReferenceAudioSpectrogram(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceAudioSpectrogramConstMeta,
      argValues: [that, startSeconds, endSeconds, columns],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceAudioSpectrogramConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_audio_spectrogram",
        argNames: ["that", "startSeconds", "endSeconds", "columns"],
      );
  ...
  BridgeCameraPose? crateApiLayerLayerReferenceCameraPoseAt(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceCameraPoseAtConstMeta,
      argValues: [that, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceCameraPoseAtConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_camera_pose_at",
        argNames: ["that", "frame"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceClearShapePathKeysConstMeta =>
      const TaskConstMeta(
  ...
  Future<BridgeSpectrogram> crateApiLayerLayerReferenceClipAudioSpectrogram(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceClipAudioSpectrogramConstMeta,
      argValues: [that, clip, startSeconds, endSeconds, columns],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceClipAudioSpectrogramConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_clip_audio_spectrogram",
        argNames: ["that", "clip", "startSeconds", "endSeconds", "columns"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceCreatePointsFromTextConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceCreateShapesFromTextConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiLayerLayerReferenceDeletePuppetPin(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceDeletePuppetPinConstMeta,
      argValues: [that, id],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceDeletePuppetPinConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_delete_puppet_pin",
        argNames: ["that", "id"],
      );
  ...
  Future<LayerReference> crateApiLayerLayerReferenceDetachAudio(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceDetachAudioConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceDetachAudioConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_detach_audio",
        argNames: ["that"],
      );
  ...
  void crateApiLayerLayerReferenceFadeIn(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceFadeInConstMeta,
      argValues: [that, seconds, shape],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceFadeInConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_fade_in",
        argNames: ["that", "seconds", "shape"],
      );
  ...
  void crateApiLayerLayerReferenceFadeOut(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceFadeOutConstMeta,
      argValues: [that, seconds, shape],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceFadeOutConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_fade_out",
        argNames: ["that", "seconds", "shape"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceFreezeAtPlayheadConstMeta =>
      const TaskConstMeta(
  ...
  BridgeCameraSettings? crateApiLayerLayerReferenceGetCameraSettings(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceGetCameraSettingsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceGetCameraSettingsConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_get_camera_settings",
        argNames: ["that"],
      );
  ...
  List<BridgeEffectInstance> crateApiLayerLayerReferenceGetClipEffects(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceGetClipEffectsConstMeta,
      argValues: [that, clip],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceGetClipEffectsConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_get_clip_effects",
        argNames: ["that", "clip"],
      );
  ...
  BridgeScalar crateApiLayerLayerReferenceGetPan(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceGetPanConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceGetPanConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_get_pan",
        argNames: ["that"],
      );
  ...
  BridgePuppet? crateApiLayerLayerReferenceGetPuppet(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceGetPuppetConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceGetPuppetConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_get_puppet",
        argNames: ["that"],
      );
  ...
  List<BridgeEffectInstance> crateApiLayerLayerReferenceGetStyles(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceGetStylesConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceGetStylesConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_get_styles",
        argNames: ["that"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceInsertNodeGroupConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiLayerLayerReferenceMoveClip(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, clip, target, toFrame, overlap],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceMoveClipConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["that", "clip", "target", "toFrame", "overlap"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceMoveShapePathKeyConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceNestedEntryFrameConstMeta =>
      const TaskConstMeta(
  ...
  BridgePuppetGhost? crateApiLayerLayerReferencePuppetGhost(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferencePuppetGhostConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferencePuppetGhostConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_puppet_ghost",
        argNames: ["that"],
      );
  ...
  void crateApiLayerLayerReferenceRenderView(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceRenderViewConstMeta,
      argValues: [that, frame, scale, width, height, effects, view],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceRenderViewConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_render_view",
        argNames: [
          "that",
          "frame",
          "scale",
  ...
  UuidValue crateApiLayerLayerReferenceRotoFirstStroke(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceRotoFirstStrokeConstMeta,
      argValues: [that, points, radius, kind, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceRotoFirstStrokeConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_roto_first_stroke",
        argNames: ["that", "points", "radius", "kind", "frame"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceSaveNodeGroupConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiLayerLayerReferenceSetCameraSettings(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceSetCameraSettingsConstMeta,
      argValues: [that, settings],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceSetCameraSettingsConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_set_camera_settings",
        argNames: ["that", "settings"],
      );
  ...
  void crateApiLayerLayerReferenceSetClipFade(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceSetClipFadeConstMeta,
      argValues: [that, clip, fadeIn, fadeOut],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceSetClipFadeConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_set_clip_fade",
        argNames: ["that", "clip", "fadeIn", "fadeOut"],
      );
  ...
  void crateApiLayerLayerReferenceSetClipFx(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceSetClipFxConstMeta,
      argValues: [that, clip, on_],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceSetClipFxConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_set_clip_fx",
        argNames: ["that", "clip", "on_"],
      );
  ...
  void crateApiLayerLayerReferenceSetClipGain(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceSetClipGainConstMeta,
      argValues: [that, clip, db],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceSetClipGainConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_set_clip_gain",
        argNames: ["that", "clip", "db"],
      );
  ...
  void crateApiLayerLayerReferenceSetPan(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceSetPanConstMeta,
      argValues: [that, value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceSetPanConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_set_pan",
        argNames: ["that", "value"],
      );
  ...
  void crateApiLayerLayerReferenceSetPuppet(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceSetPuppetConstMeta,
      argValues: [that, puppet],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceSetPuppetConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_set_puppet",
        argNames: ["that", "puppet"],
      );
  ...
  void crateApiLayerLayerReferenceSetPuppetPin(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiLayerLayerReferenceSetPuppetPinConstMeta,
      argValues: [that, pin],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiLayerLayerReferenceSetPuppetPinConstMeta =>
      const TaskConstMeta(
        debugName: "layer_reference_set_puppet_pin",
        argNames: ["that", "pin"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceSetShapePathKeysConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiLayerLayerReferenceSlideClip(
    ...
    return handler.executeSync(SyncTask(
      ...
      argValues: [that, clip, toFrame, overlap],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceSlideClipConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["that", "clip", "toFrame", "overlap"],
      );
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceStretchConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiLayerLayerReferenceToggleShapePathKeyConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiAudioListAudioDevicesConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiEffectListNodeGroupsConstMeta =>
      const TaskConstMeta(
  ...
  List<BridgeShaderNodeKind> crateApiEffectListShaderNodes() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectListShaderNodesConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectListShaderNodesConstMeta =>
      const TaskConstMeta(
        debugName: "list_shader_nodes",
        argNames: [],
      );
  ...
  List<BridgeStyleInfo> crateApiEffectListStyles() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectListStylesConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectListStylesConstMeta => const TaskConstMeta(
        debugName: "list_styles",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiEffectPluginMessagesConstMeta =>
      const TaskConstMeta(
  ...
  int crateApiProjectProjectReferenceAppliedSteps(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceAppliedStepsConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProjectProjectReferenceAppliedStepsConstMeta =>
      const TaskConstMeta(
        debugName: "project_reference_applied_steps",
        argNames: ["that"],
      );
  ...
  void crateApiProjectProjectReferenceCloseViewerView(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceCloseViewerViewConstMeta,
      argValues: [that, view],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProjectProjectReferenceCloseViewerViewConstMeta =>
      const TaskConstMeta(
        debugName: "project_reference_close_viewer_view",
        argNames: ["that", "view"],
      );
  ...
  int crateApiProjectProjectReferenceColourDepth(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceColourDepthConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProjectProjectReferenceColourDepthConstMeta =>
      const TaskConstMeta(
        debugName: "project_reference_colour_depth",
        argNames: ["that"],
      );
  ...
  int crateApiProjectProjectReferenceColourDepthInUse(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceColourDepthInUseConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProjectProjectReferenceColourDepthInUseConstMeta =>
      const TaskConstMeta(
        debugName: "project_reference_colour_depth_in_use",
        argNames: ["that"],
      );
  ...
  List<BridgeHistoryEntry> crateApiProjectProjectReferenceHistoryEntries(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceHistoryEntriesConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProjectProjectReferenceHistoryEntriesConstMeta =>
      const TaskConstMeta(
        debugName: "project_reference_history_entries",
        argNames: ["that"],
      );
  ...
  void crateApiProjectProjectReferenceJumpHistory(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceJumpHistoryConstMeta,
      argValues: [that, applied],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProjectProjectReferenceJumpHistoryConstMeta =>
      const TaskConstMeta(
        debugName: "project_reference_jump_history",
        argNames: ["that", "applied"],
      );
  ...
  void crateApiProjectProjectReferenceSetColourDepth(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceSetColourDepthConstMeta,
      argValues: [that, bits],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiProjectProjectReferenceSetColourDepthConstMeta =>
      const TaskConstMeta(
        debugName: "project_reference_set_colour_depth",
        argNames: ["that", "bits"],
      );
  ...
  void crateApiProjectProjectReferenceSetColourWorkingSpace(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiProjectProjectReferenceSetColourWorkingSpaceConstMeta,
      argValues: [that, fromConfig],
      apiImpl: this,
    ));
  }

  TaskConstMeta
      get kCrateApiProjectProjectReferenceSetColourWorkingSpaceConstMeta =>
          const TaskConstMeta(
            debugName: "project_reference_set_colour_working_space",
            argNames: ["that", "fromConfig"],
          );
  ...
  TaskConstMeta get kCrateApiEffectRescanPluginsConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiAudioResetAudioClip() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiAudioResetAudioClipConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiAudioResetAudioClipConstMeta =>
      const TaskConstMeta(
        debugName: "reset_audio_clip",
        argNames: [],
      );
  ...
  Float32List crateApiRotoRotoBoundary(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiRotoRotoBoundaryConstMeta,
      argValues: [effect, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiRotoRotoBoundaryConstMeta => const TaskConstMeta(
        debugName: "roto_boundary",
        argNames: ["effect", "frame"],
      );
  ...
  bool crateApiRotoRotoSolveFrame(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiRotoRotoSolveFrameConstMeta,
      argValues: [layer, effect, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiRotoRotoSolveFrameConstMeta => const TaskConstMeta(
        debugName: "roto_solve_frame",
        argNames: ["layer", "effect", "frame"],
      );
  ...
  PlatformInt64 crateApiRotoRotoSourceFrame(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiRotoRotoSourceFrameConstMeta,
      argValues: [layer, frame],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiRotoRotoSourceFrameConstMeta =>
      const TaskConstMeta(
        debugName: "roto_source_frame",
  ...
  BridgeRotoStatus crateApiRotoRotoStatus(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiRotoRotoStatusConstMeta,
      argValues: [layer, effect],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiRotoRotoStatusConstMeta => const TaskConstMeta(
        debugName: "roto_status",
        argNames: ["layer", "effect"],
      );
  ...
  TaskConstMeta get kCrateApiEffectSampleScalarsConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiAudioSetAudioDeviceConstMeta =>
      const TaskConstMeta(
  ...
  void crateApiShellSetFullResDragPreviews({required bool fullRes}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiShellSetFullResDragPreviewsConstMeta,
      argValues: [fullRes],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiShellSetFullResDragPreviewsConstMeta =>
      const TaskConstMeta(
        debugName: "set_full_res_drag_previews",
        argNames: ["fullRes"],
      );
  ...
  TaskConstMeta get kCrateApiEffectSetPluginEnabledConstMeta =>
      const TaskConstMeta(
  ...
  BridgeShaderGraphView crateApiEffectShaderGraphView({required String graph}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiEffectShaderGraphViewConstMeta,
      argValues: [graph],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiEffectShaderGraphViewConstMeta =>
      const TaskConstMeta(
        debugName: "shader_graph_view",
        argNames: ["graph"],
      );
  ...
  BridgeBeatGrid dco_decode_box_autoadd_bridge_beat_grid(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_beat_grid(raw);
  }

  @protected
  BridgeBeatOptions dco_decode_box_autoadd_bridge_beat_options(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_beat_options(raw);
  }
  ...
  BridgeCameraChannels dco_decode_box_autoadd_bridge_camera_channels(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_camera_channels(raw);
  }

  @protected
  BridgeCameraPose dco_decode_box_autoadd_bridge_camera_pose(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_camera_pose(raw);
  }
  ...
  BridgeCameraSettings dco_decode_box_autoadd_bridge_camera_settings(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_camera_settings(raw);
  }

  @protected
  BridgeClipFade dco_decode_box_autoadd_bridge_clip_fade(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_clip_fade(raw);
  }
  ...
  BridgeRotoFailure dco_decode_box_autoadd_bridge_roto_failure(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_roto_failure(raw);
  }
  ...
  BridgeWirePoint dco_decode_box_autoadd_bridge_wire_point(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_bridge_wire_point(raw);
  }
  ...
  BridgeAudioDevices dco_decode_bridge_audio_devices(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgeAudioDevices(
      devices: dco_decode_list_bridge_audio_device(arr[0]),
  ...
  BridgeAudioMeter dco_decode_bridge_audio_meter(dynamic raw) {
    ...
    return BridgeAudioMeter(
      layer: dco_decode_String(arr[0]),
      peakLeft: dco_decode_f_64(arr[1]),
      peakRight: dco_decode_f_64(arr[2]),
      rmsLeft: dco_decode_f_64(arr[3]),
      rmsRight: dco_decode_f_64(arr[4]),
      clipped: dco_decode_bool(arr[5]),
    );
  }
  ...
  BridgeBeatGrid dco_decode_bridge_beat_grid(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeBeatGrid(
      bpm: dco_decode_f_64(arr[0]),
      phaseSeconds: dco_decode_f_64(arr[1]),
    );
  }
  ...
  BridgeBeatOptions dco_decode_bridge_beat_options(dynamic raw) {
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return BridgeBeatOptions(
      sourceLayer: dco_decode_String(arr[0]),
      sensitivityPercent: dco_decode_u_32(arr[1]),
      workAreaOnly: dco_decode_bool(arr[2]),
      minSpacingMs: dco_decode_u_32(arr[3]),
      bpmOverride: dco_decode_f_64(arr[4]),
      phaseMs: dco_decode_f_64(arr[5]),
    );
  }
  ...
  BridgeBeatsResult dco_decode_bridge_beats_result(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeBeatsResult(
      placed: dco_decode_u_32(arr[0]),
  ...
  BridgeCameraChannels dco_decode_bridge_camera_channels(dynamic raw) {
    ...
    return BridgeCameraChannels(
      poiX: dco_decode_bridge_scalar(arr[0]),
      poiY: dco_decode_bridge_scalar(arr[1]),
      poiZ: dco_decode_bridge_scalar(arr[2]),
      zoom: dco_decode_bridge_scalar(arr[3]),
      focusDistance: dco_decode_bridge_scalar(arr[4]),
      aperture: dco_decode_bridge_scalar(arr[5]),
      blurLevel: dco_decode_bridge_scalar(arr[6]),
    );
  }
  ...
  BridgeCameraLens dco_decode_bridge_camera_lens(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeCameraLens(
      focalMm: dco_decode_f_64(arr[0]),
      angleDeg: dco_decode_f_64(arr[1]),
    );
  }
  ...
  BridgeCameraPose dco_decode_bridge_camera_pose(dynamic raw) {
    ...
    if (arr.length != 7)
      throw Exception('unexpected arr length: expect 7 but see ${arr.length}');
    return BridgeCameraPose(
      zoom: dco_decode_f_64(arr[0]),
      x: dco_decode_f_64(arr[1]),
      y: dco_decode_f_64(arr[2]),
      z: dco_decode_f_64(arr[3]),
      rotationX: dco_decode_f_64(arr[4]),
      rotationY: dco_decode_f_64(arr[5]),
      rotationZ: dco_decode_f_64(arr[6]),
    );
  }
  ...
  BridgeCameraSettings dco_decode_bridge_camera_settings(dynamic raw) {
    ...
    return BridgeCameraSettings(
      twoNode: dco_decode_bool(arr[0]),
      depthOfField: dco_decode_bool(arr[1]),
      lockToZoom: dco_decode_bool(arr[2]),
      filmSizeMm: dco_decode_f_64(arr[3]),
    );
  }
  ...
  BridgeClip dco_decode_bridge_clip(dynamic raw) {
    ...
    return BridgeClip(
      ...
      fadeIn: dco_decode_bridge_clip_fade(arr[10]),
      fadeOut: dco_decode_bridge_clip_fade(arr[11]),
      effects: dco_decode_list_bridge_effect_instance_info(arr[12]),
      fx: dco_decode_bool(arr[13]),
      gainDb: dco_decode_f_64(arr[14]),
      sourceName: dco_decode_String(arr[15]),
    );
  }
  ...
  BridgeClipFade dco_decode_bridge_clip_fade(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeClipFade(
      seconds: dco_decode_f_64(arr[0]),
      shape: dco_decode_bridge_clip_fade_shape(arr[1]),
    );
  }
  ...
  BridgeClipFadeShape dco_decode_bridge_clip_fade_shape(dynamic raw) {
    ...
    switch (raw[0]) {
      case 0:
        return BridgeClipFadeShape_Linear();
      case 1:
        return BridgeClipFadeShape_Fast();
      case 2:
        return BridgeClipFadeShape_Slow();
      case 3:
        return BridgeClipFadeShape_Smooth();
      case 4:
        return BridgeClipFadeShape_Sharp();
      case 5:
        return BridgeClipFadeShape_Custom(
  ...
  BridgeColourSummary dco_decode_bridge_colour_summary(dynamic raw) {
    ...
    return BridgeColourSummary(
      ...
      looks: dco_decode_list_String(arr[7]),
  ...
  BridgeCompModel dco_decode_bridge_comp_model(dynamic raw) {
    ...
    return BridgeCompModel(
      ...
      groups: dco_decode_list_bridge_layer_group(arr[7]),
    );
  }
  ...
  BridgeEffectInstanceInfo dco_decode_bridge_effect_instance_info(dynamic raw) {
    ...
    return BridgeEffectInstanceInfo(
      ...
      audio: dco_decode_bool(arr[4]),
      values: dco_decode_list_bridge_param_value(arr[5]),
      linkedPairs: dco_decode_list_String(arr[6]),
      badgeReason: dco_decode_opt_String(arr[7]),
  ...
  BridgeFrameProfile dco_decode_bridge_frame_profile(dynamic raw) {
    ...
    return BridgeFrameProfile(
      ...
      planMs: dco_decode_f_64(arr[2]),
      decodeMs: dco_decode_f_64(arr[3]),
      buildMs: dco_decode_f_64(arr[4]),
      compositeMs: dco_decode_f_64(arr[5]),
      presentMs: dco_decode_f_64(arr[6]),
      layers: dco_decode_list_bridge_layer_timing(arr[7]),
      view: dco_decode_u_32(arr[8]),
    );
  }
  ...
  BridgeGovernorReport dco_decode_bridge_governor_report(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgeGovernorReport(
      vram: dco_decode_bridge_tier_budget(arr[0]),
      ram: dco_decode_bridge_tier_budget(arr[1]),
      vramOverdrawnBytes: dco_decode_u_64(arr[2]),
    );
  }
  ...
  BridgeGroupSwitch dco_decode_bridge_group_switch(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeGroupSwitch.values[raw as int];
  }
  ...
  BridgeLayerGroup dco_decode_bridge_layer_group(dynamic raw) {
    ...
    if (arr.length != 11)
      throw Exception('unexpected arr length: expect 11 but see ${arr.length}');
    return BridgeLayerGroup(
      id: dco_decode_Uuid(arr[0]),
      name: dco_decode_String(arr[1]),
      label: dco_decode_u_8(arr[2]),
      members: dco_decode_list_Uuid(arr[3]),
      inFrame: dco_decode_i_64(arr[4]),
      outFrame: dco_decode_i_64(arr[5]),
      visible: dco_decode_bool(arr[6]),
      audible: dco_decode_bool(arr[7]),
      solo: dco_decode_bool(arr[8]),
      locked: dco_decode_bool(arr[9]),
      effects: dco_decode_list_bridge_effect_instance_info(arr[10]),
    );
  }
  ...
  BridgeLayerInfo dco_decode_bridge_layer_info(dynamic raw) {
    ...
    return BridgeLayerInfo(
      ...
      styles: dco_decode_list_bridge_effect_instance_info(arr[14]),
      label: dco_decode_u_8(arr[15]),
      matte: dco_decode_opt_box_autoadd_bridge_matte(arr[16]),
      retime: dco_decode_opt_box_autoadd_bridge_scalar(arr[17]),
      masks: dco_decode_list_bridge_mask(arr[18]),
      paint: dco_decode_list_bridge_stroke(arr[19]),
      puppet: dco_decode_opt_box_autoadd_bridge_puppet(arr[20]),
      shapeContents: dco_decode_list_bridge_shape_item(arr[21]),
      markers: dco_decode_list_bridge_layer_marker(arr[22]),
      flow: dco_decode_bool(arr[23]),
      flowInputRate: dco_decode_bridge_scalar(arr[24]),
      trackCorrected: dco_decode_bool(arr[25]),
      textAnimators: dco_decode_list_bridge_text_animator(arr[26]),
      source: dco_decode_opt_box_autoadd_item_reference(arr[27]),
      sourceSize: dco_decode_opt_box_autoadd_bridge_comp_size(arr[28]),
      sourceFrames: dco_decode_opt_box_autoadd_i_64(arr[29]),
      volumeDb: dco_decode_bridge_scalar(arr[30]),
      pan: dco_decode_bridge_scalar(arr[31]),
      wired: dco_decode_bool(arr[32]),
      camera: dco_decode_opt_box_autoadd_bridge_camera_settings(arr[33]),
    );
  }
  ...
  BridgeMediaSize dco_decode_bridge_media_size(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgeMediaSize(
      item: dco_decode_Uuid(arr[0]),
      width: dco_decode_u_32(arr[1]),
      height: dco_decode_u_32(arr[2]),
    );
  }
  ...
  BridgeParamKind dco_decode_bridge_param_kind(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 8:
        return BridgeParamKind_ColourName(
  ...
  BridgePluginScan dco_decode_bridge_plugin_scan(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgePluginScan(
      registered: dco_decode_list_String(arr[0]),
  ...
  BridgePuppet dco_decode_bridge_puppet(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return BridgePuppet(
      referenceTime: dco_decode_bridge_rational(arr[0]),
      density: dco_decode_f_64(arr[1]),
      expansion: dco_decode_f_64(arr[2]),
      pins: dco_decode_list_bridge_puppet_pin(arr[3]),
    );
  }
  ...
  BridgePuppetGhost dco_decode_bridge_puppet_ghost(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgePuppetGhost(
      vertices: dco_decode_list_prim_f_64_strict(arr[0]),
      triangles: dco_decode_list_prim_u_32_strict(arr[1]),
      inert: dco_decode_list_Uuid(arr[2]),
    );
  }
  ...
  BridgePuppetPin dco_decode_bridge_puppet_pin(dynamic raw) {
    ...
    if (arr.length != 9)
      throw Exception('unexpected arr length: expect 9 but see ${arr.length}');
    return BridgePuppetPin(
      id: dco_decode_Uuid(arr[0]),
      name: dco_decode_String(arr[1]),
      kind: dco_decode_bridge_puppet_pin_kind(arr[2]),
      x: dco_decode_bridge_scalar(arr[3]),
      y: dco_decode_bridge_scalar(arr[4]),
      rotation: dco_decode_bridge_scalar(arr[5]),
      scale: dco_decode_bridge_scalar(arr[6]),
      amount: dco_decode_bridge_scalar(arr[7]),
      extent: dco_decode_f_64(arr[8]),
    );
  }
  ...
  BridgePuppetPinKind dco_decode_bridge_puppet_pin_kind(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgePuppetPinKind.values[raw as int];
  }
  ...
  BridgeRotoFailure dco_decode_bridge_roto_failure(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeRotoFailure.values[raw as int];
  }

  @protected
  BridgeRotoStage dco_decode_bridge_roto_stage(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeRotoStage.values[raw as int];
  }
  ...
  BridgeRotoStatus dco_decode_bridge_roto_status(dynamic raw) {
    ...
    if (arr.length != 10)
      throw Exception('unexpected arr length: expect 10 but see ${arr.length}');
    return BridgeRotoStatus(
      stage: dco_decode_bridge_roto_stage(arr[0]),
      done: dco_decode_u_32(arr[1]),
      total: dco_decode_u_32(arr[2]),
      reused: dco_decode_u_32(arr[3]),
      failure: dco_decode_opt_box_autoadd_bridge_roto_failure(arr[4]),
      firstFrame: dco_decode_opt_box_autoadd_i_64(arr[5]),
      lastFrame: dco_decode_opt_box_autoadd_i_64(arr[6]),
      clipFrames: dco_decode_u_32(arr[7]),
      baseFrame: dco_decode_opt_box_autoadd_i_64(arr[8]),
      strokes: dco_decode_u_32(arr[9]),
    );
  }
  ...
  BridgeRotoStroke dco_decode_bridge_roto_stroke(dynamic raw) {
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return BridgeRotoStroke(
      id: dco_decode_Uuid(arr[0]),
      points: dco_decode_list_prim_f_32_strict(arr[1]),
      radius: dco_decode_f_32(arr[2]),
      kind: dco_decode_bridge_roto_stroke_kind(arr[3]),
      frame: dco_decode_i_64(arr[4]),
    );
  }
  ...
  BridgeRotoStrokeKind dco_decode_bridge_roto_stroke_kind(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeRotoStrokeKind.values[raw as int];
  }
  ...
  BridgeSampledPixels dco_decode_bridge_sampled_pixels(dynamic raw) {
    ...
    return BridgeSampledPixels(
      ...
      view: dco_decode_u_32(arr[7]),
      layerAlone: dco_decode_bool(arr[8]),
    );
  }
  ...
  BridgeShaderGraphNode dco_decode_bridge_shader_graph_node(dynamic raw) {
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return BridgeShaderGraphNode(
      id: dco_decode_u_32(arr[0]),
      kind: dco_decode_String(arr[1]),
      label: dco_decode_opt_String(arr[2]),
      inputs: dco_decode_list_bridge_shader_port(arr[3]),
      outputs: dco_decode_list_bridge_shader_port(arr[4]),
    );
  }
  ...
  BridgeShaderGraphView dco_decode_bridge_shader_graph_view(dynamic raw) {
    ...
    return BridgeShaderGraphView(
      nodes: dco_decode_list_bridge_shader_graph_node(arr[0]),
  ...
  BridgeShaderPort dco_decode_bridge_shader_port(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeShaderPort(
      id: dco_decode_String(arr[0]),
      ty: dco_decode_bridge_shader_ty(arr[1]),
    );
  }
  ...
  BridgeShaderStatus dco_decode_bridge_shader_status(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeShaderStatus(
      error: dco_decode_opt_String(arr[0]),
      notes: dco_decode_list_String(arr[1]),
    );
  }
  ...
  BridgeShaderTy dco_decode_bridge_shader_ty(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return BridgeShaderTy.values[raw as int];
  }
  ...
  BridgeSpectrogram dco_decode_bridge_spectrogram(dynamic raw) {
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return BridgeSpectrogram(
      durationSeconds: dco_decode_f_64(arr[0]),
      startSeconds: dco_decode_f_64(arr[1]),
      endSeconds: dco_decode_f_64(arr[2]),
      columns: dco_decode_u_32(arr[3]),
      bins: dco_decode_u_32(arr[4]),
      values: dco_decode_list_prim_u_8_strict(arr[5]),
    );
  }
  ...
  BridgeTierBudget dco_decode_bridge_tier_budget(dynamic raw) {
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return BridgeTierBudget(
      usedBytes: dco_decode_u_64(arr[0]),
      budgetBytes: dco_decode_u_64(arr[1]),
      peakBytes: dco_decode_u_64(arr[2]),
      denials: dco_decode_u_64(arr[3]),
      pressure: dco_decode_u_64(arr[4]),
    );
  }
  ...
  BridgeTransform dco_decode_bridge_transform(dynamic raw) {
    ...
    return BridgeTransform(
      ...
      camera: dco_decode_opt_box_autoadd_bridge_camera_channels(arr[11]),
    );
  }
  ...
  BridgeWireCamera dco_decode_bridge_wire_camera(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return BridgeWireCamera(
      layer: dco_decode_Uuid(arr[0]),
      eye: dco_decode_bridge_wire_point(arr[1]),
      corners: dco_decode_list_bridge_wire_point(arr[2]),
      pointOfInterest: dco_decode_opt_box_autoadd_bridge_wire_point(arr[3]),
    );
  }
  ...
  BridgeWireLayer dco_decode_bridge_wire_layer(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeWireLayer(
      layer: dco_decode_Uuid(arr[0]),
      corners: dco_decode_list_bridge_wire_point(arr[1]),
    );
  }
  ...
  BridgeWireLight dco_decode_bridge_wire_light(dynamic raw) {
    ...
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return BridgeWireLight(
      layer: dco_decode_Uuid(arr[0]),
      at: dco_decode_bridge_wire_point(arr[1]),
    );
  }
  ...
  BridgeWirePoint dco_decode_bridge_wire_point(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgeWirePoint(
      x: dco_decode_f_64(arr[0]),
      y: dco_decode_f_64(arr[1]),
      inFront: dco_decode_bool(arr[2]),
    );
  }
  ...
  BridgeWireframes dco_decode_bridge_wireframes(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return BridgeWireframes(
      layers: dco_decode_list_bridge_wire_layer(arr[0]),
      cameras: dco_decode_list_bridge_wire_camera(arr[1]),
      lights: dco_decode_list_bridge_wire_light(arr[2]),
    );
  }
  ...
  List<BridgeAudioMeter> dco_decode_list_bridge_audio_meter(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_audio_meter).toList();
  }
  ...
  List<BridgeLayerGroup> dco_decode_list_bridge_layer_group(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_layer_group).toList();
  }
  ...
  List<BridgeMediaSize> dco_decode_list_bridge_media_size(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_media_size).toList();
  }
  ...
  List<BridgePuppetPin> dco_decode_list_bridge_puppet_pin(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_puppet_pin).toList();
  }
  ...
  List<BridgeShaderGraphNode> dco_decode_list_bridge_shader_graph_node(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_shader_graph_node)
        .toList();
  }
  ...
  List<BridgeShaderNodeKind> dco_decode_list_bridge_shader_node_kind(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_bridge_shader_node_kind)
        .toList();
  }
  ...
  List<BridgeShaderPort> dco_decode_list_bridge_shader_port(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_shader_port).toList();
  }
  ...
  List<BridgeStyleInfo> dco_decode_list_bridge_style_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_style_info).toList();
  }
  ...
  List<BridgeWireCamera> dco_decode_list_bridge_wire_camera(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_wire_camera).toList();
  }

  @protected
  List<BridgeWireLayer> dco_decode_list_bridge_wire_layer(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_wire_layer).toList();
  }

  @protected
  List<BridgeWireLight> dco_decode_list_bridge_wire_light(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_wire_light).toList();
  }

  @protected
  List<BridgeWirePoint> dco_decode_list_bridge_wire_point(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_bridge_wire_point).toList();
  }
  ...
  BridgeBeatGrid? dco_decode_opt_box_autoadd_bridge_beat_grid(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_beat_grid(raw);
  }
  ...
  BridgeCameraChannels? dco_decode_opt_box_autoadd_bridge_camera_channels(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_bridge_camera_channels(raw);
  }

  @protected
  BridgeCameraPose? dco_decode_opt_box_autoadd_bridge_camera_pose(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_camera_pose(raw);
  }
  ...
  BridgeCameraSettings? dco_decode_opt_box_autoadd_bridge_camera_settings(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_bridge_camera_settings(raw);
  }

  @protected
  BridgeClipFade? dco_decode_opt_box_autoadd_bridge_clip_fade(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_clip_fade(raw);
  }
  ...
  BridgePuppet? dco_decode_opt_box_autoadd_bridge_puppet(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_puppet(raw);
  }
  ...
  BridgePuppetGhost? dco_decode_opt_box_autoadd_bridge_puppet_ghost(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_puppet_ghost(raw);
  }
  ...
  BridgeRotoFailure? dco_decode_opt_box_autoadd_bridge_roto_failure(
      dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_roto_failure(raw);
  }
  ...
  BridgeWirePoint? dco_decode_opt_box_autoadd_bridge_wire_point(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_bridge_wire_point(raw);
  }
  ...
  WorkerResponse dco_decode_worker_response(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 8:
        return WorkerResponse_DeviceReset();
      default:
        throw Exception("unreachable");
    }
  }
  ...
  BridgeBeatGrid sse_decode_box_autoadd_bridge_beat_grid(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_beat_grid(deserializer));
  }
  ...
  BridgeBeatOptions sse_decode_box_autoadd_bridge_beat_options(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_beat_options(deserializer));
  }
  ...
  BridgeCameraChannels sse_decode_box_autoadd_bridge_camera_channels(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_camera_channels(deserializer));
  }
  ...
  BridgeCameraPose sse_decode_box_autoadd_bridge_camera_pose(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_camera_pose(deserializer));
  }
  ...
  BridgeCameraSettings sse_decode_box_autoadd_bridge_camera_settings(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_camera_settings(deserializer));
  }
  ...
  BridgeClipFade sse_decode_box_autoadd_bridge_clip_fade(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_clip_fade(deserializer));
  }
  ...
  BridgePuppet sse_decode_box_autoadd_bridge_puppet(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_puppet(deserializer));
  }
  ...
  BridgePuppetGhost sse_decode_box_autoadd_bridge_puppet_ghost(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_puppet_ghost(deserializer));
  }
  ...
  BridgePuppetPin sse_decode_box_autoadd_bridge_puppet_pin(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_puppet_pin(deserializer));
  }
  ...
  BridgeRotoFailure sse_decode_box_autoadd_bridge_roto_failure(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_roto_failure(deserializer));
  }
  ...
  BridgeWirePoint sse_decode_box_autoadd_bridge_wire_point(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_bridge_wire_point(deserializer));
  }
  ...
  BridgeAudioDevice sse_decode_bridge_audio_device(
    ...
    return BridgeAudioDevice(
        id: var_id, name: var_name, isDefault: var_isDefault);
  }
  ...
  BridgeAudioDevices sse_decode_bridge_audio_devices(
    ...
    return BridgeAudioDevices(
        devices: var_devices, active: var_active, fellBack: var_fellBack);
  }
  ...
  BridgeAudioMeter sse_decode_bridge_audio_meter(SseDeserializer deserializer) {
    ...
    var var_peakLeft = sse_decode_f_64(deserializer);
    var var_peakRight = sse_decode_f_64(deserializer);
    var var_rmsLeft = sse_decode_f_64(deserializer);
    var var_rmsRight = sse_decode_f_64(deserializer);
    var var_clipped = sse_decode_bool(deserializer);
    return BridgeAudioMeter(
        layer: var_layer,
        peakLeft: var_peakLeft,
        peakRight: var_peakRight,
        rmsLeft: var_rmsLeft,
        rmsRight: var_rmsRight,
        clipped: var_clipped);
  }
  ...
  BridgeBeatGrid sse_decode_bridge_beat_grid(SseDeserializer deserializer) {
    ...
    var var_phaseSeconds = sse_decode_f_64(deserializer);
    return BridgeBeatGrid(bpm: var_bpm, phaseSeconds: var_phaseSeconds);
  }
  ...
  BridgeBeatOptions sse_decode_bridge_beat_options(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_sourceLayer = sse_decode_String(deserializer);
    var var_sensitivityPercent = sse_decode_u_32(deserializer);
    var var_workAreaOnly = sse_decode_bool(deserializer);
    var var_minSpacingMs = sse_decode_u_32(deserializer);
    var var_bpmOverride = sse_decode_f_64(deserializer);
    var var_phaseMs = sse_decode_f_64(deserializer);
    return BridgeBeatOptions(
        sourceLayer: var_sourceLayer,
        sensitivityPercent: var_sensitivityPercent,
        workAreaOnly: var_workAreaOnly,
        minSpacingMs: var_minSpacingMs,
        bpmOverride: var_bpmOverride,
        phaseMs: var_phaseMs);
  }
  ...
  BridgeBeatsResult sse_decode_bridge_beats_result(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_placed = sse_decode_u_32(deserializer);
    var var_bpm = sse_decode_f_64(deserializer);
    return BridgeBeatsResult(placed: var_placed, bpm: var_bpm);
  }
  ...
  BridgeCameraChannels sse_decode_bridge_camera_channels(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_poiX = sse_decode_bridge_scalar(deserializer);
    var var_poiY = sse_decode_bridge_scalar(deserializer);
    var var_poiZ = sse_decode_bridge_scalar(deserializer);
    var var_zoom = sse_decode_bridge_scalar(deserializer);
    var var_focusDistance = sse_decode_bridge_scalar(deserializer);
    var var_aperture = sse_decode_bridge_scalar(deserializer);
    var var_blurLevel = sse_decode_bridge_scalar(deserializer);
    return BridgeCameraChannels(
        poiX: var_poiX,
        poiY: var_poiY,
        poiZ: var_poiZ,
        zoom: var_zoom,
        focusDistance: var_focusDistance,
        aperture: var_aperture,
        blurLevel: var_blurLevel);
  }

  @protected
  BridgeCameraLens sse_decode_bridge_camera_lens(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_focalMm = sse_decode_f_64(deserializer);
    var var_angleDeg = sse_decode_f_64(deserializer);
    return BridgeCameraLens(focalMm: var_focalMm, angleDeg: var_angleDeg);
  }
  ...
  BridgeCameraPose sse_decode_bridge_camera_pose(SseDeserializer deserializer) {
    ...
    var var_rotationX = sse_decode_f_64(deserializer);
    var var_rotationY = sse_decode_f_64(deserializer);
    var var_rotationZ = sse_decode_f_64(deserializer);
    return BridgeCameraPose(
        zoom: var_zoom,
        x: var_x,
        y: var_y,
  ...
  BridgeCameraSettings sse_decode_bridge_camera_settings(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_twoNode = sse_decode_bool(deserializer);
    var var_depthOfField = sse_decode_bool(deserializer);
    var var_lockToZoom = sse_decode_bool(deserializer);
    var var_filmSizeMm = sse_decode_f_64(deserializer);
    return BridgeCameraSettings(
        twoNode: var_twoNode,
        depthOfField: var_depthOfField,
        lockToZoom: var_lockToZoom,
        filmSizeMm: var_filmSizeMm);
  }
  ...
  BridgeClip sse_decode_bridge_clip(SseDeserializer deserializer) {
    ...
    var var_fadeIn = sse_decode_bridge_clip_fade(deserializer);
    var var_fadeOut = sse_decode_bridge_clip_fade(deserializer);
  ...
  BridgeClipFade sse_decode_bridge_clip_fade(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_seconds = sse_decode_f_64(deserializer);
    var var_shape = sse_decode_bridge_clip_fade_shape(deserializer);
    return BridgeClipFade(seconds: var_seconds, shape: var_shape);
  }
  ...
  BridgeClipFadeShape sse_decode_bridge_clip_fade_shape(
    ...
    switch (tag_) {
      ...
      case 5:
        ...
        return BridgeClipFadeShape_Custom(
            x1: var_x1, y1: var_y1, x2: var_x2, y2: var_y2);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  BridgeColourSummary sse_decode_bridge_colour_summary(
    ...
    var var_looks = sse_decode_list_String(deserializer);
    var var_name = sse_decode_String(deserializer);
  ...
  BridgeCompModel sse_decode_bridge_comp_model(SseDeserializer deserializer) {
    ...
    var var_groups = sse_decode_list_bridge_layer_group(deserializer);
    return BridgeCompModel(
  ...
  BridgeEffectValue sse_decode_bridge_effect_value(
    ...
    switch (tag_) {
      ...
      case 8:
        var var_field0 = sse_decode_opt_Uuid(deserializer);
        return BridgeEffectValue_Clip(var_field0);
      case 9:
        var var_field0 = sse_decode_opt_Uuid(deserializer);
      ...
      case 11:
        ...
        return BridgeEffectValue_Text(var_field0);
      default:
        throw UnimplementedError('');
    }
  }
  ...
  BridgeFadeShape sse_decode_bridge_fade_shape(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeFadeShape.values[inner];
  }
  ...
  BridgeFrameProfile sse_decode_bridge_frame_profile(
    ...
    var var_planMs = sse_decode_f_64(deserializer);
    var var_decodeMs = sse_decode_f_64(deserializer);
    var var_buildMs = sse_decode_f_64(deserializer);
    var var_compositeMs = sse_decode_f_64(deserializer);
    var var_presentMs = sse_decode_f_64(deserializer);
    ...
    return BridgeFrameProfile(
        ...
        totalMs: var_totalMs,
        planMs: var_planMs,
        decodeMs: var_decodeMs,
        buildMs: var_buildMs,
        compositeMs: var_compositeMs,
        presentMs: var_presentMs,
        layers: var_layers,
        view: var_view);
  }
  ...
  BridgeGovernorReport sse_decode_bridge_governor_report(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_vram = sse_decode_bridge_tier_budget(deserializer);
    var var_ram = sse_decode_bridge_tier_budget(deserializer);
    var var_vramOverdrawnBytes = sse_decode_u_64(deserializer);
    return BridgeGovernorReport(
        vram: var_vram,
        ram: var_ram,
        vramOverdrawnBytes: var_vramOverdrawnBytes);
  }
  ...
  BridgeGroupSwitch sse_decode_bridge_group_switch(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeGroupSwitch.values[inner];
  }
  ...
  BridgeHistoryEntry sse_decode_bridge_history_entry(
    ...
    return BridgeHistoryEntry(name: var_name, undone: var_undone);
  }
  ...
  BridgeLayerGroup sse_decode_bridge_layer_group(SseDeserializer deserializer) {
    ...
    var var_members = sse_decode_list_Uuid(deserializer);
  ...
  BridgeLayerInfo sse_decode_bridge_layer_info(SseDeserializer deserializer) {
    ...
    var var_effects = sse_decode_list_bridge_effect_instance_info(deserializer);
    var var_styles = sse_decode_list_bridge_effect_instance_info(deserializer);
    var var_label = sse_decode_u_8(deserializer);
    ...
    var var_puppet = sse_decode_opt_box_autoadd_bridge_puppet(deserializer);
    ...
    var var_pan = sse_decode_bridge_scalar(deserializer);
    var var_wired = sse_decode_bool(deserializer);
    var var_camera =
        sse_decode_opt_box_autoadd_bridge_camera_settings(deserializer);
    return BridgeLayerInfo(
        name: var_name,
        kind: var_kind,
  ...
  BridgeMediaSize sse_decode_bridge_media_size(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_item = sse_decode_Uuid(deserializer);
    var var_width = sse_decode_u_32(deserializer);
    var var_height = sse_decode_u_32(deserializer);
    return BridgeMediaSize(
        item: var_item, width: var_width, height: var_height);
  }
  ...
  BridgeNodeGroup sse_decode_bridge_node_group(SseDeserializer deserializer) {
    ...
    return BridgeNodeGroup(
        name: var_name, colour: var_colour, members: var_members);
  }
  ...
  BridgePuppet sse_decode_bridge_puppet(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_referenceTime = sse_decode_bridge_rational(deserializer);
    var var_density = sse_decode_f_64(deserializer);
    var var_expansion = sse_decode_f_64(deserializer);
    var var_pins = sse_decode_list_bridge_puppet_pin(deserializer);
    return BridgePuppet(
        referenceTime: var_referenceTime,
        density: var_density,
        expansion: var_expansion,
        pins: var_pins);
  }
  ...
  BridgePuppetGhost sse_decode_bridge_puppet_ghost(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_vertices = sse_decode_list_prim_f_64_strict(deserializer);
    var var_triangles = sse_decode_list_prim_u_32_strict(deserializer);
    var var_inert = sse_decode_list_Uuid(deserializer);
    return BridgePuppetGhost(
        vertices: var_vertices, triangles: var_triangles, inert: var_inert);
  }
  ...
  BridgePuppetPin sse_decode_bridge_puppet_pin(SseDeserializer deserializer) {
    ...
    var var_id = sse_decode_Uuid(deserializer);
    var var_name = sse_decode_String(deserializer);
    var var_kind = sse_decode_bridge_puppet_pin_kind(deserializer);
    var var_x = sse_decode_bridge_scalar(deserializer);
    var var_y = sse_decode_bridge_scalar(deserializer);
    var var_rotation = sse_decode_bridge_scalar(deserializer);
    var var_scale = sse_decode_bridge_scalar(deserializer);
    var var_amount = sse_decode_bridge_scalar(deserializer);
    var var_extent = sse_decode_f_64(deserializer);
    return BridgePuppetPin(
        id: var_id,
        name: var_name,
        kind: var_kind,
  ...
  BridgePuppetPinKind sse_decode_bridge_puppet_pin_kind(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgePuppetPinKind.values[inner];
  }
  ...
  BridgeRotoFailure sse_decode_bridge_roto_failure(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeRotoFailure.values[inner];
  }
  ...
  BridgeRotoStage sse_decode_bridge_roto_stage(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeRotoStage.values[inner];
  }

  @protected
  BridgeRotoStatus sse_decode_bridge_roto_status(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_stage = sse_decode_bridge_roto_stage(deserializer);
    var var_done = sse_decode_u_32(deserializer);
    var var_total = sse_decode_u_32(deserializer);
    var var_reused = sse_decode_u_32(deserializer);
    var var_failure =
        sse_decode_opt_box_autoadd_bridge_roto_failure(deserializer);
    var var_firstFrame = sse_decode_opt_box_autoadd_i_64(deserializer);
    var var_lastFrame = sse_decode_opt_box_autoadd_i_64(deserializer);
    var var_clipFrames = sse_decode_u_32(deserializer);
    var var_baseFrame = sse_decode_opt_box_autoadd_i_64(deserializer);
    var var_strokes = sse_decode_u_32(deserializer);
    return BridgeRotoStatus(
        stage: var_stage,
        done: var_done,
        total: var_total,
        ...
        lastFrame: var_lastFrame,
        clipFrames: var_clipFrames,
        baseFrame: var_baseFrame,
        strokes: var_strokes);
  }
  ...
  BridgeRotoStroke sse_decode_bridge_roto_stroke(SseDeserializer deserializer) {
    ...
    var var_kind = sse_decode_bridge_roto_stroke_kind(deserializer);
    var var_frame = sse_decode_i_64(deserializer);
    return BridgeRotoStroke(
        id: var_id,
        points: var_points,
  ...
  BridgeRotoStrokeKind sse_decode_bridge_roto_stroke_kind(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeRotoStrokeKind.values[inner];
  }
  ...
  BridgeShaderGraphNode sse_decode_bridge_shader_graph_node(
    ...
    var var_inputs = sse_decode_list_bridge_shader_port(deserializer);
    var var_outputs = sse_decode_list_bridge_shader_port(deserializer);
    return BridgeShaderGraphNode(
        id: var_id,
        kind: var_kind,
        label: var_label,
  ...
  BridgeShaderGraphView sse_decode_bridge_shader_graph_view(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_nodes = sse_decode_list_bridge_shader_graph_node(deserializer);
    var var_error = sse_decode_opt_String(deserializer);
    return BridgeShaderGraphView(nodes: var_nodes, error: var_error);
  }
  ...
  BridgeShaderNodeKind sse_decode_bridge_shader_node_kind(
    ...
    var var_kind = sse_decode_String(deserializer);
    var var_category = sse_decode_String(deserializer);
    return BridgeShaderNodeKind(kind: var_kind, category: var_category);
  }
  ...
  BridgeShaderPort sse_decode_bridge_shader_port(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_id = sse_decode_String(deserializer);
    var var_ty = sse_decode_bridge_shader_ty(deserializer);
    return BridgeShaderPort(id: var_id, ty: var_ty);
  }
  ...
  BridgeShaderStatus sse_decode_bridge_shader_status(
    ...
    return BridgeShaderStatus(error: var_error, notes: var_notes);
  }
  ...
  BridgeShaderTy sse_decode_bridge_shader_ty(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return BridgeShaderTy.values[inner];
  }
  ...
  @protected
  BridgeSpectrogram sse_decode_bridge_spectrogram(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_durationSeconds = sse_decode_f_64(deserializer);
    var var_startSeconds = sse_decode_f_64(deserializer);
    ...
    var var_values = sse_decode_list_prim_u_8_strict(deserializer);
    return BridgeSpectrogram(
        durationSeconds: var_durationSeconds,
        startSeconds: var_startSeconds,
        endSeconds: var_endSeconds,
  ...
  BridgeTierBudget sse_decode_bridge_tier_budget(SseDeserializer deserializer) {
    ...
    var var_denials = sse_decode_u_64(deserializer);
    var var_pressure = sse_decode_u_64(deserializer);
    return BridgeTierBudget(
        usedBytes: var_usedBytes,
        budgetBytes: var_budgetBytes,
  ...
  BridgeTransform sse_decode_bridge_transform(SseDeserializer deserializer) {
    ...
    var var_opacity = sse_decode_bridge_scalar(deserializer);
    var var_camera =
        sse_decode_opt_box_autoadd_bridge_camera_channels(deserializer);
    return BridgeTransform(
        anchorX: var_anchorX,
        anchorY: var_anchorY,
        positionX: var_positionX,
  ...
  BridgeWireCamera sse_decode_bridge_wire_camera(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_layer = sse_decode_Uuid(deserializer);
    var var_eye = sse_decode_bridge_wire_point(deserializer);
    var var_corners = sse_decode_list_bridge_wire_point(deserializer);
    var var_pointOfInterest =
        sse_decode_opt_box_autoadd_bridge_wire_point(deserializer);
    return BridgeWireCamera(
        layer: var_layer,
        eye: var_eye,
        corners: var_corners,
        pointOfInterest: var_pointOfInterest);
  }
  ...
  BridgeWireLayer sse_decode_bridge_wire_layer(SseDeserializer deserializer) {
    ...
    var var_layer = sse_decode_Uuid(deserializer);
    var var_corners = sse_decode_list_bridge_wire_point(deserializer);
    return BridgeWireLayer(layer: var_layer, corners: var_corners);
  }
  ...
  BridgeWireLight sse_decode_bridge_wire_light(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_layer = sse_decode_Uuid(deserializer);
    var var_at = sse_decode_bridge_wire_point(deserializer);
    return BridgeWireLight(layer: var_layer, at: var_at);
  }
  ...
  BridgeWirePoint sse_decode_bridge_wire_point(SseDeserializer deserializer) {
    ...
    var var_x = sse_decode_f_64(deserializer);
    var var_y = sse_decode_f_64(deserializer);
    var var_inFront = sse_decode_bool(deserializer);
    return BridgeWirePoint(x: var_x, y: var_y, inFront: var_inFront);
  }

  @protected
  BridgeWireframes sse_decode_bridge_wireframes(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_layers = sse_decode_list_bridge_wire_layer(deserializer);
    var var_cameras = sse_decode_list_bridge_wire_camera(deserializer);
    var var_lights = sse_decode_list_bridge_wire_light(deserializer);
    return BridgeWireframes(
        layers: var_layers, cameras: var_cameras, lights: var_lights);
  }
  ...
  List<BridgeAudioDevice> sse_decode_list_bridge_audio_device(
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_audio_device(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeAudioMeter> sse_decode_list_bridge_audio_meter(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeAudioMeter>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_audio_meter(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeLayerGroup> sse_decode_list_bridge_layer_group(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeLayerGroup>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_layer_group(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeMediaSize> sse_decode_list_bridge_media_size(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeMediaSize>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_media_size(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeNodeGroup> sse_decode_list_bridge_node_group(
    ...
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_node_group(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgePuppetPin> sse_decode_list_bridge_puppet_pin(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgePuppetPin>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_puppet_pin(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeShaderGraphNode> sse_decode_list_bridge_shader_graph_node(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeShaderGraphNode>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_shader_graph_node(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeShaderNodeKind> sse_decode_list_bridge_shader_node_kind(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeShaderNodeKind>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_shader_node_kind(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeShaderPort> sse_decode_list_bridge_shader_port(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeShaderPort>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_shader_port(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeStyleInfo> sse_decode_list_bridge_style_info(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeStyleInfo>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_style_info(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeWireCamera> sse_decode_list_bridge_wire_camera(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeWireCamera>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_wire_camera(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeWireLayer> sse_decode_list_bridge_wire_layer(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeWireLayer>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_wire_layer(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeWireLight> sse_decode_list_bridge_wire_light(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeWireLight>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_wire_light(deserializer));
    }
    return ans_;
  }
  ...
  List<BridgeWirePoint> sse_decode_list_bridge_wire_point(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <BridgeWirePoint>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_bridge_wire_point(deserializer));
    }
    return ans_;
  }
  ...
  BridgeBeatGrid? sse_decode_opt_box_autoadd_bridge_beat_grid(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_beat_grid(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeCameraChannels? sse_decode_opt_box_autoadd_bridge_camera_channels(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_camera_channels(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeCameraPose? sse_decode_opt_box_autoadd_bridge_camera_pose(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_camera_pose(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeCameraSettings? sse_decode_opt_box_autoadd_bridge_camera_settings(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_camera_settings(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeClipFade? sse_decode_opt_box_autoadd_bridge_clip_fade(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_clip_fade(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgePuppet? sse_decode_opt_box_autoadd_bridge_puppet(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_puppet(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgePuppetGhost? sse_decode_opt_box_autoadd_bridge_puppet_ghost(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_puppet_ghost(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeRotoFailure? sse_decode_opt_box_autoadd_bridge_roto_failure(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_roto_failure(deserializer));
    } else {
      return null;
    }
  }
  ...
  BridgeWirePoint? sse_decode_opt_box_autoadd_bridge_wire_point(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_bridge_wire_point(deserializer));
    } else {
      return null;
    }
  }
  ...
  void sse_encode_box_autoadd_bridge_beat_grid(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_beat_grid(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_beat_options(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_beat_options(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_camera_channels(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_camera_channels(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_camera_pose(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_camera_pose(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_camera_settings(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_camera_settings(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_clip_fade(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_clip_fade(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_puppet(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_puppet(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_puppet_ghost(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_puppet_ghost(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_puppet_pin(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_puppet_pin(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_roto_failure(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_roto_failure(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_bridge_wire_point(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_wire_point(self, serializer);
  }
  ...
  void sse_encode_bridge_audio_meter(
    ...
    sse_encode_f_64(self.peakLeft, serializer);
    sse_encode_f_64(self.peakRight, serializer);
    sse_encode_f_64(self.rmsLeft, serializer);
    sse_encode_f_64(self.rmsRight, serializer);
    sse_encode_bool(self.clipped, serializer);
  }
  ...
  void sse_encode_bridge_beat_grid(
    ...
    sse_encode_f_64(self.phaseSeconds, serializer);
  }
  ...
  void sse_encode_bridge_beat_options(
      BridgeBeatOptions self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.sourceLayer, serializer);
    sse_encode_u_32(self.sensitivityPercent, serializer);
    sse_encode_bool(self.workAreaOnly, serializer);
    sse_encode_u_32(self.minSpacingMs, serializer);
    sse_encode_f_64(self.bpmOverride, serializer);
    sse_encode_f_64(self.phaseMs, serializer);
  }
  ...
  void sse_encode_bridge_beats_result(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_u_32(self.placed, serializer);
    sse_encode_f_64(self.bpm, serializer);
  }
  ...
  void sse_encode_bridge_camera_channels(
      BridgeCameraChannels self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_scalar(self.poiX, serializer);
    sse_encode_bridge_scalar(self.poiY, serializer);
    sse_encode_bridge_scalar(self.poiZ, serializer);
    sse_encode_bridge_scalar(self.zoom, serializer);
    sse_encode_bridge_scalar(self.focusDistance, serializer);
    sse_encode_bridge_scalar(self.aperture, serializer);
    sse_encode_bridge_scalar(self.blurLevel, serializer);
  }
  ...
  void sse_encode_bridge_camera_lens(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_f_64(self.focalMm, serializer);
  ...
  void sse_encode_bridge_camera_pose(
    ...
    sse_encode_f_64(self.rotationX, serializer);
    sse_encode_f_64(self.rotationY, serializer);
    sse_encode_f_64(self.rotationZ, serializer);
  }
  ...
  void sse_encode_bridge_camera_settings(
      BridgeCameraSettings self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bool(self.twoNode, serializer);
    sse_encode_bool(self.depthOfField, serializer);
    sse_encode_bool(self.lockToZoom, serializer);
    sse_encode_f_64(self.filmSizeMm, serializer);
  }
  ...
  void sse_encode_bridge_clip(BridgeClip self, SseSerializer serializer) {
    ...
    sse_encode_bridge_clip_fade(self.fadeIn, serializer);
    sse_encode_bridge_clip_fade(self.fadeOut, serializer);
  ...
  void sse_encode_bridge_clip_fade(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_f_64(self.seconds, serializer);
    sse_encode_bridge_clip_fade_shape(self.shape, serializer);
  }
  ...
  void sse_encode_bridge_colour_summary(
    ...
    sse_encode_list_String(self.looks, serializer);
    sse_encode_String(self.name, serializer);
  ...
  void sse_encode_bridge_comp_model(
    ...
    sse_encode_list_bridge_layer_group(self.groups, serializer);
  }
  ...
  void sse_encode_bridge_effect_value(
    ...
    switch (self) {
      ...
      case BridgeEffectValue_Clip(field0: final field0):
      ...
      case BridgeEffectValue_Text(field0: final field0):
  ...
  void sse_encode_bridge_frame_profile(
    ...
    sse_encode_f_64(self.planMs, serializer);
    sse_encode_f_64(self.decodeMs, serializer);
    sse_encode_f_64(self.buildMs, serializer);
    sse_encode_f_64(self.compositeMs, serializer);
    sse_encode_f_64(self.presentMs, serializer);
  ...
  void sse_encode_bridge_governor_report(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_tier_budget(self.vram, serializer);
    sse_encode_bridge_tier_budget(self.ram, serializer);
    sse_encode_u_64(self.vramOverdrawnBytes, serializer);
  }
  ...
  void sse_encode_bridge_layer_group(
    ...
    sse_encode_list_Uuid(self.members, serializer);
  ...
  void sse_encode_bridge_layer_info(
    ...
    sse_encode_list_bridge_effect_instance_info(self.effects, serializer);
    sse_encode_list_bridge_effect_instance_info(self.styles, serializer);
    sse_encode_u_8(self.label, serializer);
    ...
    sse_encode_opt_box_autoadd_bridge_puppet(self.puppet, serializer);
    ...
    sse_encode_bridge_scalar(self.pan, serializer);
    sse_encode_bool(self.wired, serializer);
    sse_encode_opt_box_autoadd_bridge_camera_settings(self.camera, serializer);
  }
  ...
  void sse_encode_bridge_media_size(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_Uuid(self.item, serializer);
    sse_encode_u_32(self.width, serializer);
    sse_encode_u_32(self.height, serializer);
  }
  ...
  void sse_encode_bridge_puppet(BridgePuppet self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_rational(self.referenceTime, serializer);
    sse_encode_f_64(self.density, serializer);
    sse_encode_f_64(self.expansion, serializer);
    sse_encode_list_bridge_puppet_pin(self.pins, serializer);
  }
  ...
  void sse_encode_bridge_puppet_ghost(
      BridgePuppetGhost self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_prim_f_64_strict(self.vertices, serializer);
    sse_encode_list_prim_u_32_strict(self.triangles, serializer);
    sse_encode_list_Uuid(self.inert, serializer);
  }
  ...
  void sse_encode_bridge_puppet_pin(
    ...
    sse_encode_Uuid(self.id, serializer);
    sse_encode_String(self.name, serializer);
    sse_encode_bridge_puppet_pin_kind(self.kind, serializer);
    sse_encode_bridge_scalar(self.x, serializer);
    sse_encode_bridge_scalar(self.y, serializer);
    sse_encode_bridge_scalar(self.rotation, serializer);
    sse_encode_bridge_scalar(self.scale, serializer);
    sse_encode_bridge_scalar(self.amount, serializer);
    sse_encode_f_64(self.extent, serializer);
  }
  ...
  void sse_encode_bridge_roto_status(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_bridge_roto_stage(self.stage, serializer);
    sse_encode_u_32(self.done, serializer);
    sse_encode_u_32(self.total, serializer);
    sse_encode_u_32(self.reused, serializer);
    sse_encode_opt_box_autoadd_bridge_roto_failure(self.failure, serializer);
    sse_encode_opt_box_autoadd_i_64(self.firstFrame, serializer);
    sse_encode_opt_box_autoadd_i_64(self.lastFrame, serializer);
    sse_encode_u_32(self.clipFrames, serializer);
    sse_encode_opt_box_autoadd_i_64(self.baseFrame, serializer);
    sse_encode_u_32(self.strokes, serializer);
  }
  ...
  void sse_encode_bridge_roto_stroke(
    ...
    sse_encode_bridge_roto_stroke_kind(self.kind, serializer);
    sse_encode_i_64(self.frame, serializer);
  }
  ...
  void sse_encode_bridge_shader_graph_node(
    ...
    sse_encode_list_bridge_shader_port(self.inputs, serializer);
    sse_encode_list_bridge_shader_port(self.outputs, serializer);
  }
  ...
  void sse_encode_bridge_shader_graph_view(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_bridge_shader_graph_node(self.nodes, serializer);
  ...
  void sse_encode_bridge_shader_port(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.id, serializer);
    sse_encode_bridge_shader_ty(self.ty, serializer);
  }
  ...
  void sse_encode_bridge_spectrogram(
    ...
    sse_encode_list_prim_u_8_strict(self.values, serializer);
  }
  ...
  void sse_encode_bridge_tier_budget(
    ...
    sse_encode_u_64(self.denials, serializer);
    sse_encode_u_64(self.pressure, serializer);
  }
  ...
  void sse_encode_bridge_transform(
    ...
    sse_encode_bridge_scalar(self.opacity, serializer);
    sse_encode_opt_box_autoadd_bridge_camera_channels(self.camera, serializer);
  }
  ...
  void sse_encode_bridge_wire_camera(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_Uuid(self.layer, serializer);
    sse_encode_bridge_wire_point(self.eye, serializer);
    sse_encode_list_bridge_wire_point(self.corners, serializer);
    sse_encode_opt_box_autoadd_bridge_wire_point(
        self.pointOfInterest, serializer);
  }
  ...
  void sse_encode_bridge_wire_light(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_Uuid(self.layer, serializer);
    sse_encode_bridge_wire_point(self.at, serializer);
  }
  ...
  void sse_encode_bridge_wire_point(
    ...
    sse_encode_f_64(self.x, serializer);
    sse_encode_f_64(self.y, serializer);
    sse_encode_bool(self.inFront, serializer);
  }
  ...
  void sse_encode_bridge_wireframes(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_list_bridge_wire_layer(self.layers, serializer);
    sse_encode_list_bridge_wire_camera(self.cameras, serializer);
    sse_encode_list_bridge_wire_light(self.lights, serializer);
  }
  ...
  void sse_encode_list_bridge_audio_device(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_audio_device(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_audio_meter(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_audio_meter(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_layer_group(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_layer_group(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_media_size(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_media_size(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_node_group(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_node_group(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_puppet_pin(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_puppet_pin(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_shader_graph_node(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_shader_graph_node(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_shader_node_kind(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_shader_node_kind(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_shader_port(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_shader_port(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_style_info(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_style_info(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_wire_camera(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_wire_camera(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_wire_layer(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_wire_layer(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_wire_light(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_wire_light(item, serializer);
    }
  }
  ...
  void sse_encode_list_bridge_wire_point(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_bridge_wire_point(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_beat_grid(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_beat_grid(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_camera_channels(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_camera_channels(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_camera_pose(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_camera_pose(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_camera_settings(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_camera_settings(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_clip_fade(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_clip_fade(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_puppet(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_puppet(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_puppet_ghost(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_puppet_ghost(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_roto_failure(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_roto_failure(self, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_bridge_wire_point(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_bridge_wire_point(self, serializer);
    }
  }
...
class BridgeEffectInstanceImpl extends RustOpaque
  ...
  void detachShaderGraph() => BridgeLib.instance.api
          .crateApiEffectBridgeEffectInstanceDetachShaderGraph(
        that: this,
      );
  ...
  List<BridgeParamInfo> listParameters() =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceListParameters(
        that: this,
      );
  ...
  void rotoAddStroke(
          ...
          required BridgeRotoStrokeKind kind,
          required PlatformInt64 frame}) =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceRotoAddStroke(
  ...
  void rotoClear() =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceRotoClear(
        that: this,
      );
  ...
  void setShaderGraph({required String graph}) =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceSetShaderGraph(
          that: this, graph: graph);
  ...
  void setShaderSource({required String source, String? origin}) =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceSetShaderSource(
          that: this, source: source, origin: origin);
  ...
  String? shaderGraph() =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceShaderGraph(
        that: this,
      );
  ...
  /// on another machine.
  String? shaderOrigin() =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceShaderOrigin(
        that: this,
      );
  ...
  String? shaderSource() =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceShaderSource(
        that: this,
      );
  ...
  BridgeShaderStatus shaderStatus() =>
      BridgeLib.instance.api.crateApiEffectBridgeEffectInstanceShaderStatus(
        that: this,
      );
}
