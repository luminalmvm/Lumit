...
class BridgeLib
  ...
  @override
  int get rustContentHash => 2032821066;
...
abstract class BridgeLibApi extends BaseApi {
  ...
  String crateApiExportExportSpecCheck({required BridgeExportSpec spec});
...
class BridgeLibApiImpl extends BridgeLibApiImplPlatform
  ...
  String crateApiExportExportSpecCheck({required BridgeExportSpec spec}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiExportExportSpecCheckConstMeta,
      argValues: [spec],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiExportExportSpecCheckConstMeta =>
      const TaskConstMeta(
        debugName: "export_spec_check",
        argNames: ["spec"],
      );
