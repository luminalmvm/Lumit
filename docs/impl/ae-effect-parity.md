...
- **Distort batch (2026-08-20)** — Turbulent displace (§3.38), Tile (§3.39), Offset
  ...
  *sample position*, and where the two paths contract a multiply-add differently the
  ...
  default tiles** (§3.39), was **withdrawn by K-442**: §1.2 asks that an effect look right
  ...
  K-442 also fills in the half of Motion Tile that was missing: Output width and height
