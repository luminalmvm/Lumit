...
- **Contrast** controls the intensity of the effect. 100 is neutral, 0 flattens the
  picture to grey and 200 doubles the distance every value sits from mid-grey. The
  response is finest near 100 and coarsens towards either end.
