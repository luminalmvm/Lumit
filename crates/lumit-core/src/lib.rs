...
pub mod graph;
/// Layer groups: the Timeline's organisational fold over a run of layers.
pub mod group;
pub mod lighting;
pub mod linalg;
pub mod lut;
...
pub mod mask;
pub mod model;
/// Occlusion culling: the full-frame opaque layer that hides what is under it.
pub mod occlusion;
pub mod ops;
pub mod paint;
pub mod pixels;
...
pub mod text;
pub mod time;
/// The solve link: a Camera layer driven by a tracked layer.
pub mod track;
