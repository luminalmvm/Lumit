// The screen matte's two neighbourhood stages (docs/08-EFFECTS.md §3.21, K-446):
...
// STAGE 3 (K-446): one separable morphological pass. The edge marches without
...
// STAGE 5 (K-446): remove isolated specks. A speck is a pixel that disagrees
