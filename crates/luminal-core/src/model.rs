...
pub struct MediaRef {
    ...
    /// Unknown fields from newer Luminal versions, preserved on load/save
...
pub enum LayerKind {
    ...
    /// one row — Luminal's Vegas-style editing surface. Resolution lives in
    /// [`crate::sequence`].
    Sequence {
        #[serde(default)]
...
/// The folders Luminal files new assets into automatically: the first solid
