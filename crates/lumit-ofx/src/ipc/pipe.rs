...
/// A name nobody can guess is most of the defence against the programs best
/// placed to guess it, which are the other brokers - each running somebody
/// else's plugin code. [`lumit_ipc::pipe_name`] has the longer version.
#[must_use]
