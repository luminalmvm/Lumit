...
//!
//! In plain terms: before rendering, Luminal turns a composition into a wiring
...
use luminal_core::model::{BlendMode, Composition, LayerKind};
...
mod tests {
    ...
    use luminal_core::mask::Mask;
    use luminal_core::model::{Composition, LayerKind, LinearColour, Switches, TransformGroup};
    ...
    fn layer(kind: LayerKind, masks: Vec<Mask>) -> luminal_core::model::Layer {
        luminal_core::model::Layer {
            id: Uuid::now_v7(),
            name: "l".into(),
            kind,
            in_point: secs(0),
    ...
    fn footage(retime: Option<Retime>, masks: Vec<Mask>) -> luminal_core::model::Layer {
        layer(
            LayerKind::Footage {
                item: Uuid::now_v7(),
                retime,
    ...
    fn comp_with(layers: Vec<luminal_core::model::Layer>) -> Composition {
        Composition {
            id: Uuid::now_v7(),
            name: "c".into(),
            width: 1920,
